...
<head>
    <meta charset="UTF-8">
    <title>Student cancelled office single small</title>
    <style>
        .total-due {
            margin-left: 5px;
        }
...
<body>
    <div style="max-width:850px; margin: 0 auto; padding: 0 5px;font-size:10px;">
        <div style="width: 48%; padding: 15px 5px; margin-left: 230px;">
        ...
        <div style="width: 100%;">
            <div class="content" style="width: 385px; margin: auto; border: 2px solid #000; padding-bottom: 5px; position:relative;">
