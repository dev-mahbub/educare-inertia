...
<head>
    <meta charset="UTF-8">
    <title>Student cancelled office small</title>
    <style>
        .total-due {
            margin-left: 5px;
        }
...
<body>
    <div style="max-width:850px; margin: 0 auto; padding: 0 5px;font-size:10px;">
        ...
        <div style="width: 48%; float: left; padding: 0 5px;">
            <div style="width: 385px; margin: auto; border: 2px solid #000; padding-bottom: 5px; position:relative;">
                <div style=" position:absolute; left:12%; bottom:9%; transform: rotate(-45deg);">
                            ...
                            <td style="width: 80%; vertical-align: top; text-align: center;">
                                <table style="text-align: center; width: 100%">
                                    ...
                                    <tr>
                                        <td>
                                            <small style="font-size: 11px;">
                                                {{ __(!empty($schoolData['street_address']) ? $schoolData['street_address'] . ', ' : '') }}
                                    ...
                                    <tr>
                                        <td style="padding-left: 10px; padding-right: 10px; padding-top: 3px; padding-bottom: 3px; background-color:#DDDDDD;"><small style="font-size: 11px;">{{ __('Fee Receipt (Student Copy)') }}</small></td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td style="vertical-align: top; width: 50%;">
                                <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse;">
                                    <tbody>
                                        <tr>
                                            <td style="margin-bottom: 0px; padding-bottom: 3px; font-size:12px"><strong>{{ __('Receipt No.') }}</strong></td>
                                        ...
                                        <tr>
                                            <td style="margin-bottom: 0px; padding-bottom: 3px; font-size:12px"><strong>{{ __('Student\'s Name.') }}</strong></td>
                                            <td style="margin-bottom: 0px; padding-bottom: 3px; font-size:11px">
                                        ...
                                        <tr>
                                            <td style="margin-bottom: 0px; padding-bottom: 3px; font-size:12px"><strong>{{ __('Father\'s Name.') }}</strong></td>
                                            <td style="margin-bottom: 0px; padding-bottom: 3px; font-size:11px">
                                        ...
                                        <tr>
                                            <td style="margin-bottom: 0px; padding-bottom: 3px; font-size:12px"><strong>{{ __('Class.') }}</strong></td>
                                            <td style="margin-bottom: 0px; padding-bottom: 3px; font-size:11px">
                                        ...
                                        <!-- <tr>
                                                <td style="margin-bottom: 0px; padding-bottom: 3px;"><strong>{{ __('Pay.Type') }}</strong></td>
                            ...
                            <td style="padding-left: 10px; vertical-align: top; width: 50%;">
                                <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse;">
                                    <tbody>
                                        <tr>
                                            <td style="margin-bottom: 0px; padding-bottom: 3px; margin-left:50px; font-size:12px"><strong>{{ __('Date.') }}</strong></td>
                                        ...
                                        <tr>
                                            <td style="margin-bottom: 0px; padding-bottom: 3px; margin-left:5px; font-size:12px"><strong>{{ __('Admission No..') }}</strong></td>
                                            <td style="margin-bottom: 0px; padding-bottom: 3px; solid #000; font-size:11px">
                                        ...
                                        <tr>
                                            <td style="margin-bottom: 0px; padding-bottom: 3px; margin-left:5px; font-size:12px"><strong>{{ __('Mode.') }}</strong></td>
                                            <td style="margin-bottom: 0px; padding-bottom: 3px; solid #000; font-size:11px">
                ...
                <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse; margin-top: 5px;">
                    <tr style="border: 1px solid #000; border-left: 0!important; border-right: 0!important;">
                        ...
                        <th style="text-align: right; padding-right: 10px; border-bottom: 1px solid #000; font-size:13px"><small>Amount (Rs.)</small></th>
                    </tr>

                    @if (!empty($report) && count($report['payments']) > 0)
                    @foreach ($report['payments'] as $payment)
                    <tr>
                        <td style="text-align: right; border-right: 1px solid #000; padding-right: 10px; font-size:12px">{{ __($payment['fee_type_title']) }}</td>
                        <td style="text-align: right; padding-right: 10px; border-bottom: 1px solid #000; font-size:12px">{{ __($payment['amount'] ?? 0) }}</td>
                    </tr>
                    @endforeach
                    @endif

                    <tr>
                        <td style="text-align: right; border-top: 1px solid #000; border-right: 1px solid #000; padding-right: 10px; border-bottom: 1px solid #000; font-size:12px">{{ __('Total Amount') }}</td>
                    ...
                    <tr>
                        <td style="text-align: right; border-right: 1px solid #000; padding-right: 10px; border-bottom: 1px solid #000; font-size:12px">{{ __('Discount') }}</td>
                        <td style="text-align: right; padding-right: 10px; border-bottom: 1px solid #000; font-size:12px">
                    ...
                    <tr>
                        <td style="text-align: right; border-right: 1px solid #000; padding-right: 10px; border-bottom: 1px solid #000; font-size:12px">{{ __('Payable') }}</td>
                        <td style="text-align: right; padding-right: 10px; border-bottom: 1px solid #000; font-size:12px">
                    ...
                    <tr>
                        <td style="text-align: right; border-right: 1px solid #000; padding-right: 10px; border-bottom: 1px solid #000; font-size:12px">{{ __('Paid: ') }}
                    ...
                    <tr>
                        <td style="text-align: right; border-right: 1px solid #000; padding-right: 10px; border-bottom: 1px solid #000; font-size:12px">{{ __('Due') }}</td>
                ...
                <!-- <div class="total-due">
                        <small style=""><strong>Total Due - {{!empty($report['student_total_due']) ? __($report['student_total_due']) : __(0)}}</strong></small>
                    </div> -->
                        ...
                        <tr style="width: 100%;">
                            ...
                            <td style="width: 80%; vertical-align: top; text-align: center;">
                                <table style="text-align: center; width: 100%">
                                    ...
                                    <tr>
                                        <td style="padding-left: 10px; padding-right: 10px; padding-top: 3px; padding-bottom: 3px; background-color:#DDDDDD;"><small style="font-size: 11px;">{{ __('Fee Receipt (School Copy)') }}</small></td>
                                    </tr>
                                </table>
                            </td>
                            <td style="width: 10%; vertical-align: top; text-align: right;">
    ...
    <script>
        function printContent() {
            ...
            var elementToRemove = document.getElementById('printButton');
            if (elementToRemove) {
