...
<head>
    <meta charset="UTF-8">
    <title>Student cancelled office single</title>
    <style>
        @media print {
            #printButton {
                display: none;
...
<body>
    <div style="max-width:850px; margin: 0 auto; padding: 0 5px;font-size:10px;">
        ...
        <div style="position:relative">
            <div style=" position:absolute; left:16%; bottom:24%; transform: rotate(-45deg);">
                <p id="watermark_text">receipt <br> cancelled</p>
            </div>
                    ...
                    <tr>
                        <td style="vertical-align: top; width: 50%;">
                            <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse;">
                                <tbody>
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px;">{{ __('Admission No.') }}</td>
                                    ...
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px;">{{ __('Student\'s Name') }}</td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; border-bottom: 1px solid #C4C4C4;">
                                            <strong>
                                    ...
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px;">{{ __('Father\'s Name') }}</td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; border-bottom: 1px solid #C4C4C4;">
                                            <strong>
                                    ...
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px;">{{ __('Pay.Type') }}</td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; border-bottom: 1px solid #C4C4C4;">
                        ...
                        <td style="padding-left:30px; vertical-align: top; width: 50%;">
                            <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse;">
                                <tbody>
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; margin-left:50px;"><strong>{{ __('Receipt No') }}</strong></td>
                                    ...
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; margin-left:5px;"><strong>{{ __('Receipt Date') }}</strong></td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; solid #000; border-bottom: 1px solid #C4C4C4;">
                                    ...
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; margin-left:5px;"><strong>{{ __('Class') }}</strong></td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; solid #000; border-bottom: 1px solid #C4C4C4;">
                                    ...
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; margin-left:5px;"><strong>{{ __('Pay.Type') }}</strong></td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; solid #000; border-bottom: 1px solid #C4C4C4;">
                                            @if (!empty($report['receipt_title']))
                                            {{ __($report['receipt_title']) }}
                                            @endif
                        ...
                        <td style="padding-left:30px; vertical-align: top; width: 50%;">
                            <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse;">
                                <tbody>
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; margin-left:50px;"><strong>{{ __('Scl Receipt No') }}</strong></td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; solid #000; border-bottom: 1px solid #C4C4C4;">
                                    ...
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; margin-left:5px;"><strong>{{ __('Pay.Mode') }}</strong></td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; solid #000; border-bottom: 1px solid #C4C4C4;">
                                    ...
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; margin-left:5px;"><strong>{{ __('Roll.No') }}</strong></td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; solid #000; border-bottom: 1px solid #C4C4C4;">
                                            @if (!empty($report['student']))
            ...
            <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse; border: 1px solid #000; margin-top: 20px;">
                <tr style="border: 1px solid #000;">
                    <th style="text-align: left; border-right: 1px solid #ADADAD; padding-left: 10px;"><small>{{ __('Fee Type') }}</small></th>
                    <th style="text-align: right; padding-right: 10px; border-right: 1px solid #ADADAD; border-right: 1px solid #ADADAD;"><small>{{ __('Due Amount (Rs.)') }}</small></th>
                    <th style="text-align: right; padding-right: 10px; border-bottom: 1px solid #ddd;"><small>Paid Amount (Rs.)</small></th>
                </tr>
                ...
                <!-- <tr>
                <td style="border-right; border-right: 1px solid #ADADAD; padding-left: 10px; border-bottom: 1px solid #ddd;"><small>{{ __('Admission Fee') }}</small></td>
                <td style="text-align: right; padding-right: 10px; border-right: 1px solid #ADADAD; border-bottom: 1px solid #ddd;"><small>{{ __('6000') }}</small></td>
                <td style="text-align: right; padding-right: 10px; border-bottom: 1px solid #ddd;"><small>{{ __('1450') }}</small></td>
            </tr>
            <tr>
                <td style="border-right; border-right: 1px solid #ADADAD; padding-left: 10px; border-bottom: 1px solid #ddd;"><small>{{ __('Child Kit') }}</small></td>
                <td style="text-align: right; padding-right: 10px; border-right: 1px solid #ADADAD; border-bottom: 1px solid #ddd;"><small>{{ __('700') }}</small></td>
                <td style="text-align: right; padding-right: 10px; border-bottom: 1px solid #ddd;"><small>{{ __('700') }}</small></td>
            </tr>
            <tr>
                <td style="border-right; border-right: 1px solid #ADADAD; padding-left: 10px; border-bottom: 1px solid #ddd;"><small>{{ __('Development Fee') }}</small></td>
                <td style="text-align: right; padding-right: 10px; border-right: 1px solid #ADADAD; border-bottom: 1px solid #ddd;"><small>{{ __('3000') }}</small></td>
                <td style="text-align: right; padding-right: 10px; border-bottom: 1px solid #ddd;"><small>{{ __('3000') }}</small></td>
            </tr>
            <tr>
                <td style="border-right; border-right: 1px solid #ADADAD; padding-left: 10px; border-bottom: 1px solid #ddd;"><small>{{ __('Examination Fee') }}</small></td>
                <td style="text-align: right; padding-right: 10px; border-right: 1px solid #ADADAD; border-bottom: 1px solid #ddd;"><small>{{ __('1000') }}</small></td>
                <td style="text-align: right; padding-right: 10px; border-bottom: 1px solid #ddd;"><small>{{ __('1000') }}</small></td>
            </tr>
            <tr>
                <td style="border-right; border-right: 1px solid #ADADAD; padding-left: 10px; border-bottom: 1px solid #ddd;"><small>{{ __('Registration Fee') }}</small></td>
                <td style="text-align: right; padding-right: 10px; border-right: 1px solid #ADADAD; border-bottom: 1px solid #ddd;"><small>{{ __('350') }}</small></td>
                <td style="text-align: right; padding-right: 10px; border-bottom: 1px solid #ddd;"><small>{{ __('350') }}</small></td>
            </tr> -->

                <tr>
                    <td style="border-right; border-right: 1px solid #ADADAD; padding-left: 10px; border-bottom: 1px solid #ddd;"><strong><small>{{ __('Total Amount') }}</small></strong></td>
                    <td style="text-align: right; padding-right: 10px; border-right: 1px solid #ADADAD; border-bottom: 1px solid #ddd;">
                        <strong>
                            <small>
                ...
                <tr>
                    <td style="border-right; border-right: 1px solid #ADADAD; padding-left: 10px; border-bottom: 1px solid #ddd;"><strong><small>{{ __('Discount') }}</small></strong></td>
                    <td style="text-align: right; padding-right: 10px; border-right: 1px solid #ADADAD; border-bottom: 1px solid #ddd;">
                        <strong>
                            <small>
                ...
                <tr>
                    <td style="border-right; border-right: 1px solid #ADADAD; padding-left: 10px; border-bottom: 1px solid #ddd;"><strong><small>{{ __('Payable') }}</small></strong></td>
                    <td style="text-align: right; padding-right: 10px; border-right: 1px solid #ADADAD; border-bottom: 1px solid #ddd;"><strong>{{ __('') }}</strong></td>
                    <td style="text-align: right; padding-right: 10px; border-bottom: 1px solid #ddd;">
                        <strong>
                            <small>
                ...
                <tr>
                    <td style="border-right; border-right: 1px solid #ADADAD; padding-left: 10px; border-bottom: 1px solid #ddd;"><strong><small>
                                {{ __('Paid: ') }}
                ...
                <tr>
                    <td style="border-right; border-right: 1px solid #ADADAD; padding-left: 10px;"><strong><small>{{ __('Due') }}</small></strong></td>
                    <td style="text-align: right; padding-right: 10px; border-right: 1px solid #ADADAD;">{{ __('') }}</td>
                ...
                <tfoot>
                    <tr>
                        <td style="margin:0; padding:0; width:33%; vertical-align:bottom; text-align: right;">
                            ...
                            <strong><small>Auth. Signatory</small></strong>
                        </td>
                    </tr>
                </tfoot>
            </table>
