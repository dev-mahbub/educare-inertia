...
<head>
    <meta charset="UTF-8">
    <title>Student cancelled office Large</title>
    <style>
        @media print {
            #printButton {
                display: none;
        ...
        <div style="position:relative">
            ...
            <table style="width: 100%; font-family: 'Inter', sans-serif;">
                <thead>
                    ...
                    <tr>
                        <td><small>{{ __('Fee Receipt (Student Copy)') }}</small></td>
                    </tr>
            </table>
            </td>
                        ...
                        <td style="vertical-align: top; width: 50%;">
                            <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse;">
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px;">{{ __('Student\'s Name') }}
                                        </td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; border-bottom: 1px solid #C4C4C4;">
                                            <strong>
                                    ...
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px;">{{ __('Father\'s Name') }}
                                        </td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; border-bottom: 1px solid #C4C4C4;">
                                            <strong>
        ...
        <div style="position:relative">
            ...
            <table style="width: 100%; font-family: 'Inter', sans-serif;">
                <thead>
                    ...
                    <tr>
                        <td><small>{{ __('Fee Receipt (School Copy)') }}</small></td>
                    </tr>
            </table>
            </td>
            <td style="width: 20%; vertical-align: top; text-align: right;">
                    ...
                    <tr>
                        <td style="vertical-align: top; width: 50%;">
                            <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse;">
                                <tbody>
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px;">{{ __('Admission No.') }}
                                        </td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; border-bottom: 1px solid #C4C4C4;">
                                            @if (!empty($report['student']['admission_no']))
                                            {{ __($report['student']['admission_no']) }}
            ...
            <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse; border: 1px solid #000; margin-top: 20px;">
                ...
                <tr>
                    <td style="border-right; border-right: 1px solid #ADADAD; padding-left: 10px; border-bottom: 1px solid #ddd;">
                        <strong><small>{{ __('Paid') }}</small></strong>
                    </td>
                    <td style="text-align: right; padding-right: 10px; border-right: 1px solid #ADADAD; border-bottom: 1px solid #ddd;">
                        <strong>{{ __('') }}</strong>
                    </td>
