...
<head>
    <meta charset="UTF-8">
    <title>Student paid Large</title>
    <style>
        @media print {
        ...
        <div style="">
                    ...
                    <tr>
                        <td style="vertical-align: top; width: 50%;">
                            <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse;">
                                <tbody>
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px;font-weight:bold">{{ __('Admission No.') }}</td>
                                    ...
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px;font-weight:bold">{{ __('Student\'s Name') }}</td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; border-bottom: 1px solid #C4C4C4;">
                                            <strong>
                                    ...
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px;font-weight:bold">{{ __('Father\'s Name') }}</td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; border-bottom: 1px solid #C4C4C4;">
                                            <strong>
            ...
            <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse; border: 1px solid #000; margin-top: 5px;">
                ...
                <tr>
                    ...
                    <td style="text-align: right; padding-right: 10px; border-bottom: 1px solid #ddd;"><strong>{{ __('') }}</strong></td>
                </tr>
                <tr>
            ...
            <table style="width: 100%; font-family: 'Inter', sans-serif;">
                <thead>
                    <tr style="width: 100%;">
                        ...
                        <td style="width: 60%; vertical-align: top; text-align: center;">
                            <table style="text-align: center; width: 100%; font-size:14px; font-weight:bold">
                                <tr>
                                    <td>
                                        <h2 style="font-size:24px; margin:0px;">
                                            @if (!empty($schoolData['title']))
