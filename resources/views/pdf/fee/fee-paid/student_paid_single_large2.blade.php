...
<head>
    <meta charset="UTF-8">
    <title>Student paid single Large2</title>
    <style>
        @media print {
                    ...
                    <tr>
                        <td style="vertical-align: top; width: 50%;">
                            <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse;">
                                <tbody>
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px;dbps">{{ __('Admission No.') }}</td>
                                    ...
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px;dbps">{{ __('Student\'s Name') }}
                                        </td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; border-bottom: 1px solid #C4C4C4;">
                                            <strong>
                                    ...
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px;dbps">{{ __('Father\'s Name') }}
                                        </td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; border-bottom: 1px solid #C4C4C4;">
                                            <strong>
                                    ...
                                    <tr>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px;dbps">{{ __('Pay.Type') }}</td>
                                        <td style="margin-bottom: 0px; padding-bottom: 3px; border-bottom: 1px solid #C4C4C4;">
                                            {{ __('Payment for Admission Fee') }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
