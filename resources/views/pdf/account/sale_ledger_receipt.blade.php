        ...
        <div>
                            ...
                            <table style="text-align:center; width:100%">
                                <tr>
                                    <td
                                        ...
                                        @if ($saleLedger?->sale_type_for == 'Teacher')
                                        <h3 style="margin: 0;">{{ __('Receipt (Staff Copy)') }}</h3>
                                        @else
                            ...
                            <table
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            style="margin-bottom:10px; padding-bottom:3px; border-bottom:1px solid #ddd; width:50%;">
                                            {{ __(($saleLedger?->student?->first_name ?? '').' '.($saleLedger?->student?->middle_name ?? '').' '.($saleLedger?->student?->last_name ?? '')) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="margin-bottom:10px; padding-bottom:3px; width:50%;">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            style="margin-bottom:10px; padding-bottom:3px; border-bottom:1px solid #ddd; width:50%;">
                                            {{ __(($saleLedger?->student?->father?->first_name ?? '').' '.($saleLedger?->student?->father?->middle_name ?? '').' '.($saleLedger?->student?->father?->last_name ?? '')) }}
                                        </td>
                                    </tr>
                                    @endif
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            style="margin-bottom:10px; padding-bottom:3px; border-bottom:1px solid #ddd; width:50%;">
                                            {{ __(($saleLedger?->staff?->first_name ?? '').' '.($saleLedger?->staff?->middle_name ?? '').' '.($saleLedger?->staff?->last_name ?? '')) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="margin-bottom:10px; padding-bottom:3px; width:50%;">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            style="margin-bottom:10px; padding-bottom:3px; border-bottom:1px solid #ddd; width:50%;">
                                            {{ __($saleLedger?->bankLedger?->title) }}
                                        </td>
                                    </tr>
                                    <!-- <tr>
                                        <td style="margin-bottom:10px; padding-bottom:3px; width:50%;">
                            ...
                            <table
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            style="margin-bottom:10px; padding-bottom:3px; border-bottom:1px solid #ddd; width:50%;">
                                            {{ __($saleLedger?->student?->admission_no) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                        ...
                                        <td
                                            style="margin-bottom:10px; padding-bottom:3px; border-bottom:1px solid #ddd; width:50%;">
                                            {{ __($saleLedger?->student?->classroomRoll?->roll_no) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="margin-bottom:10px; padding-bottom:3px; width:50%;">
            ...
            <table
                ...
                <tbody>
                    ...
                    @if (count($saleLedger->saleLedgerProducts ?? []) > 0)
                    @foreach ($saleLedger->saleLedgerProducts as $ledgerProduct)
                    <tr>
                        <td
                    ...
                    <tr>
                        ...
                        <td
                            style="margin:0;vertical-align:top; text-align:left; padding:5px; border:1px solid #ddd; border-left: none !important; font-weight:700;">
                            <div style="display: flex; justify-content: space-between">
                                <span>{{ $saleLedger?->paid_type == 'Paid' ? $saleLedger->total ?? 0 : 0 }}</span>
                            </div>
                        </td>
                    </tr>
                    @if ($saleLedger?->paid_type == 'Unpaid')
                    <tr>
                        <td style="border:1px solid #ddd;"></td>
                        <td style="border:1px solid #ddd;"></td>
                        <td style="border:1px solid #ddd;"></td>
                    ...
                    <tr>
                        <td style="margin:0; padding:0; width:50%; text-align:right;">
                            <h4 style="margin: 0; font-size:12px; margin-bottom: 2px; font-weight:400">
                                {{ __(($saleLedger?->createdBy?->first_name ?? '').' '.($saleLedger?->createdBy?->middle_name ?? '').' '.($saleLedger?->createdBy?->last_name ?? '')) }}
                            </h4>
