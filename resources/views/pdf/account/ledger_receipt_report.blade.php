...
<head>
    <meta charset="UTF-8">
    <title>Ledger Receipt Report </title>
    <style>
        .table-container {
            width: 30%;
            float: left;
...
<body>
        ...
        <tr>
            <td style="vertical-align: middle; text-align: center;">
                <table>
                    ...
                    <tr>
                        <td>
                            <h6 style="font-size: 13px">{{__("Inventory Receipt Report")}}</h6>
    ...
    <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse; margin-bottom: 10px; margin-top: 10px; border-left: 1px solid #EEEEEE; border-right: 1px solid #EEEEEE;">
        <tbody>
            <tr>
                ...
                <th style="margin:0;vertical-align: middle; text-align: center; padding: 5px; background: #EEEEEE;">{{ __('Receipt Date') }}</th>
            ...
            @foreach ($receiptReport['reports'] as $index => $report)
            <tr>
                ...
                <td style="margin: 0;vertical-align: top; text-align: center; padding:5px; border-bottom: 1px solid #EEEEEE; color: #030105">{{ __($report['ledger'] ?? "") }}</td>
            ...
            <tr>
                ...
                <td style="margin: 0;vertical-align: top; text-align: center; padding:5px; border-bottom: 1px solid #EEEEEE; color: #030105"></td>
                <td style="margin: 0;vertical-align: top; text-align: center; padding:5px; border-bottom: 1px solid #EEEEEE; color: #030105"></td>
                <td style="margin: 0;vertical-align: top; text-align: center; padding:5px; border-bottom: 1px solid #EEEEEE; color: #030105">{{ $paymentItem['ledger'] ?? '' }}</td>
            ...
            <tr>
                ...
                <td style="margin: 0;vertical-align: top; text-align: center; padding:5px; color: #030105; border-bottom: 1px solid #EEEEEE;">{{ __($receiptReport['total_amount'] ?? 0) }}</td>
            </tr>
        </tbody>
    </table>
            ...
            <tr>
                <td style="vertical-align: middle; text-align: center;">
                    <table>
                        <tr>
                            <td>
                                <h6 style="font-size: 13px">{{__("Receipt Summary")}}</h6>
                                <h6 style="font-size: 13px">{{ __(!empty($reportDateTitle) ? $reportDateTitle : '') }}</h6>
                            </td>
                        </tr>
                    </table>
    ...
    <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse; margin-bottom: 10px; margin-top: 10px; border-left: 1px solid #EEEEEE; border-right: 1px solid #EEEEEE;">
        <tbody>
            ...
            @if (!empty($receiptSummary['reports']))
            @foreach (array_values($receiptSummary['reports']) as $index => $report)
            <tr>
                <td style="margin: 0;vertical-align: top; text-align: center; padding:5px; border-bottom: 1px solid #EEEEEE; color: #030105">{{ __($index + 1) }}</td>
                <td style="margin: 0;vertical-align: top; text-align: center; padding:5px; border-bottom: 1px solid #EEEEEE; color: #030105">{{ __($report['ledger'] ?? "") }}</td>
                <td style="margin: 0;vertical-align: top; text-align: center; padding:5px; border-bottom: 1px solid #EEEEEE; color: #030105">{{ __($report['amount'] ?? 0) }}</td>
            ...
            <tr>
                <td style="margin: 0;vertical-align: top; text-align: center; padding:5px; color: #030105; border-bottom: 1px solid #EEEEEE;">{{ __('') }}</td>
                <td style="margin: 0;vertical-align: top; text-align: center; padding:5px; color: #030105; border-bottom: 1px solid #EEEEEE;">{{ __('Total') }}</td>
                <td style="margin: 0;vertical-align: top; text-align: center; padding:5px; color: #030105; border-bottom: 1px solid #EEEEEE;">{{ __($receiptSummary['total_amount'] ?? 0) }}</td>
            </tr>
        </tbody>
    </table>
