...
<body>
    @if (!empty($salePaidReport['reports']))
        ...
        <tr>
            <td style="vertical-align: middle; text-align: center;">
                <table>
                    ...
                    <tr>
                        <td>
                            <h6 style="font-size: 13px">{{ __('Student Sale Paid Register') }}</h6>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse; margin-bottom: 10px; margin-top: 10px; border-left: 1px solid #EEEEEE; border-right: 1px solid #EEEEEE;">
        <tbody>
            ...
            @foreach ($salePaidReport['reports'] as $index => $report)
            <tr>
            ...
            <tr>
                ...
                <td style="margin: 0; background: #EEEEEE; vertical-align: top; text-align: center; padding:5px; color: #030105; border-bottom: 1px solid #EEEEEE;">{{ __($salePaidReport['total_paid_amount'] ?? 0) }}</td>
            </tr>
        </tbody>
    </table>
