                            ...
                            <table style="text-align:center; width:100%">
                                <tr>
                                    <td
                                        ...
                                        <h3 style="margin: 0;">{{ __('Journal Voucher') }}</h3>
                                    </td>
                                </tr>
                            </table>
                        </td>
            ...
            <table
                ...
                <tbody>
                    <tr>
                        ...
                        <th
                            style="margin:0;vertical-align:top; text-align:right; padding:5px; border:1px solid #ddd; font-weight:700; width: 33%">
                            <h4 style="margin: 0;">
                                {{ __('Debit') }}
                            </h4>
                        </th>
                    ...
                    @if (count($journal->journalLedgers ?? []) > 0)
                    ...
                    <tr>
                        ...
                        <td
                            ...
                            {{ $journalLedger->debit_amount ?? '' }}
                        </td>
                        <td
                            style="margin:0;vertical-align:top; text-align:right; padding:5px; border:1px solid #ddd; border-left: none !important; font-weight:400; width:33%">
                            {{ $journalLedger->credit_amount ?? '' }}
                        </td>
                    </tr>
                    @endforeach
                    @endif
                    ...
                    <tr>
                        <td style="margin:0;vertical-align:top; text-align:center; padding:5px; border:1px solid #ddd; font-weight:700; width:33%">
                            <span>Total</span>
                        </td>
                        <td style="margin:0;vertical-align:top; text-align:right; padding:5px; border:1px solid #ddd; border-left: none !important; font-weight:700; width:33%">
                    ...
                    <tr>
                        <td style="margin:0; padding:0; width:50%; text-align:right;">
                            <h4 style="margin: 0; font-size:12px; margin-bottom: 2px; font-weight:400">
                                <!-- {{ __(($journal?->createdBy?->first_name ?? '').' '.($journal?->createdBy?->middle_name ?? '').' '.($journal?->createdBy?->last_name ?? '')) }} -->
                            </h4>
