        ...
        <div>
                            ...
                            <table style="text-align:center; width:100%">
                                <tr>
                                    <td
                                        ...
                                        <h3 style="margin: 0;">{{ __('Payment Voucher') }}</h3>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            {{ __($ledgerPayment?->bankLedger?->title) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="margin-bottom:10px; padding-bottom:3px; width:50%;">
            ...
            <table
                ...
                <tbody>
                    ...
                    @if (count($ledgerPayment->ledger_payment_items ?? []) > 0)
                    @foreach ($ledgerPayment->ledger_payment_items as $paymentItem)
                    <tr>
                        <td
                            style="margin:0;vertical-align:top; text-align:left; padding:5px; border:1px solid #ddd; font-weight:400; width:33%">
                            {{ __($paymentItem?->ledger?->title) }}
                        </td>
                        <td
                    ...
                    <tr>
                        ...
                        <td
                            ...
                            <div style="display: flex; justify-content: space-between">
                                ...
                                <span>{{ $ledgerPayment->total ?? 0 }}</span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="margin:0; padding:0; width:50%; text-align:right;">
                            <h4 style="margin: 0; font-size:12px; margin-bottom: 2px; font-weight:400">
                                {{ __(($ledgerPayment?->createdBy?->first_name ?? '').' '.($ledgerPayment?->createdBy?->middle_name ?? '').' '.($ledgerPayment?->createdBy?->last_name ?? '')) }}
                            </h4>
                        ...
                        <td style="width:70%; padding-top:10px;">
                            <table style="text-align:center; width:100%">
                                <tr>
                                    <td
                                        style="width: 100%; padding-top:5px; padding-bottom:5px; border:1px solid #ddd; display:inline-block; background-color:#efefef;">
                                        <h3 style="margin: 0;">{{ __('Payment Voucher (Office Copy)') }}</h3>
                                    </td>
                                </tr>
                            </table>
                        </td>
