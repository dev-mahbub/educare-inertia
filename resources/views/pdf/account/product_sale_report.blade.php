...
<body>
    @if (!empty($productSaleReport['reports']))
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            ...
                            <h6 style="font-size: 13px">{{ __('Sales Report ('.$reportDateTitle.')') }}</h6>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse; margin-bottom: 10px; margin-top: 10px; border-left: 1px solid #EEEEEE; border-right: 1px solid #EEEEEE;">
        <tbody>
            ...
            @foreach ($productSaleReport['reports'] as $index => $report)
            <tr>
            ...
            <tr>
                ...
                <td style="margin: 0; background: #EEEEEE; vertical-align: top; text-align: center; padding:5px; color: #030105; border-bottom: 1px solid #EEEEEE;">{{ __($productSaleReport['total_quantity'] ?? 0) }}</td>
                <td style="margin: 0; background: #EEEEEE; vertical-align: top; text-align: center; padding:5px; color: #030105; border-bottom: 1px solid #EEEEEE;">{{ __('') }}</td>
                <td style="margin: 0; background: #EEEEEE; vertical-align: top; text-align: center; padding:5px; color: #030105; border-bottom: 1px solid #EEEEEE;">{{ __($productSaleReport['total_tax_amount'] ?? 0) }}</td>
                <td style="margin: 0; background: #EEEEEE; vertical-align: top; text-align: center; padding:5px; color: #030105; border-bottom: 1px solid #EEEEEE;">{{ __($productSaleReport['total_discount_amount'] ?? 0) }}</td>
                <td style="margin: 0; background: #EEEEEE; vertical-align: top; text-align: center; padding:5px; color: #030105; border-bottom: 1px solid #EEEEEE;">{{ __($productSaleReport['total_amount'] ?? 0) }}</td>
            </tr>
        </tbody>
    </table>
