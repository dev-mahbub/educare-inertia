                ...
                <table>
                    ...
                    <tr>
                        <td>
                            ...
                            <span style="font-size:16px; font-weight:800; padding-right:20px">{{ __("Class Name: ". $classroomTitle ) }}</span>
    ...
    <table style="width: 100%; font-family: 'Inter', sans-serif; border-collapse: collapse; margin-top: 10px; border-left: 1px solid #EEEEEE; border-right: 1px solid #EEEEEE;">
        <thead>
            <tr>
                ...
                @foreach ($classroomPeriods as $index => $period)
        ...
        <tbody>
            ...
            <tr>
                <th>{{ $timetable['day'] ?? '' }}</th>
                @foreach ($classroomPeriods as $period)
                ...
                <td style="margin: 0;vertical-align: top; text-align: center; padding:5px; border-bottom: 1px solid #EEEEEE; color: #030105">
                    ...
                    <div>
                        ...
                        <br />
                        <span style="font-size: 12px; font-weight: 400;">{{ $periodData['teacher_name'] ?? '' }}</span>
                    </div>
                    @endforeach
                </td>
                @else
