...
<head>
    ...
    <style>
        ...
        /*
        ul.educare-cards li:nth-child(5n+10) {
...
<body style="margin:0;">
    <table style="width: 90%; text-align: right;">
        <tr class="educare-printarea">
            <th
                style="width: 100%; text-align: right; font-weight: 400; font-size: 13px; height: 30px; padding-right: 10%;">
                <input type="submit" value="Print" onclick="window.print()" id="btnSave"
                    style="background: #459414; color: #fff; background: #2196F3; padding: 3px 9px; margin-right: 5px; border-radius: 3px; width: 72px;">
                <input type="submit" value="Back" id="btnSave" onclick="window.close();"
                    style="background: #459414; color: #fff; background: #2196F3; padding: 3px 9px; margin-right: 5px; border-radius: 3px; width: 72px;">
            </th>
        </tr>
    </table>
            ...
            <tr style="vertical-align: top;">
                <td style="width:100%;">
                    ...
                    <table class="educare-OuterTable"
                        style="margin: 0 auto;font-family: Nunito;border-spacing: 0;border-collapse: collapse;        width: 1170.92px;height: auto;margin-top: 0px;">
                        <thead>
                            <!--title row-->
                            <tr>
                                <th
                                    ...
                                    <ul class="educare-cards">
                                        @if (count($classWiseStudentData) > 0)
                                            @foreach ($classWiseStudentData as $classWiseStudent)
                                                <li>
                                                    <div
                                                        style="background-size: cover; width: 2.125in; height: 3.375in; overflow: hidden; border: 1px solid #000;">
                                                        ...
                                                        <table style="width: 100%;">
                                                            <tr>
                                                                <td style="width: 20%">
                                                                    <img width="80"
                                                                        src="{{ $classWiseStudent['school_logo']['path'] ?? '' }}"
                                                                        alt="School">
                                                                </td>
                                                                <td
                                                                    style="width: 80%;color: black;font-weight: 800;font-family: roboto;line-height: 15px;font-size: 13px;">
                                                                    {{ $classWiseStudent['school_data']['title'] ?? '' }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td
                                                                    style="text-align: center; padding-left: 35px; padding-top: 7px;">
                                                                    <span
                                                                        style="background-color: red; font-size: 10px; padding: 2px 5px; color: #fff;">The
                                                                        Education For Success</span>
                                                                </td>
                                                            </tr>

                                                            <tr>
                                                                <td
                                                                    style="text-align: center; font-size: 10px; padding-left: 45px; line-height: 3px;">
                                                                    Ph. :
                                                                    {{ $classWiseStudent['school_data']['phone'] ?? '' }}
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table
                                                            style="width: 100%; font-size: 12px; font-family: roboto;">
                                                            <tbody>
                                                                <tr>
                                                                    <td
                                                                        style="height: 81px; width: 21%; vertical-align: top; text-align: center; padding-left: 36px;">
                                                                        <span
                                                                            style="display: inline-block; padding-top: 16px; font-size: 12px; width: 27px; color: #6b302c;"></span>
                                                                    </td>
                                                                    <td
                                                                        style="background-size: cover; height: 81px; width: 40%;">
                                                                        @if ($classWiseStudent['student_image'] && $classWiseStudent['student_image']['path'])
                                                                            <img src="{{ $classWiseStudent['student_image']['path'] ?? '' }}"
                                                                                alt="student profile picture"
                                                                                style="height: 74px; width: 65px; border-radius: 3px; padding-left: 2px; padding-top: 13px;">
                                                                        @else
                                                                            <svg style="margin-bottom:13px;"
                                                                                width="65" height="74"
                                                                    ...
                                                                    <td
                                                                        style="background-size: cover; height: 81px; width: 29%; text-align: left; position: relative;">
                                                                        <div
                                                                            style="width: 71px; position: absolute; transform: rotate(270deg); left: -8px; top: 39px; font-weight: 600;">
                                                                            {{ $classWiseStudent['classroom']['academic_year']['academic_session'] ?? '' }}
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        ...
                                                        <table
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td
                                                                        style="text-align: center; font-size: 11px; padding-top: 20px; font-weight: 600;padding-left: 15px">
                                                                        {{ $classWiseStudent['first_name'] ?? '' }}
                                                                        {{ $classWiseStudent['middle_name'] ?? '' }}
                                                                        {{ $classWiseStudent['last_name'] ?? '' }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <table
                                                                            style="width: 100%; font-size: 12px; font-family: roboto; margin-top:5px;"
                                                                            cellpadding="0" cellspacing="0">
                                                                            <tr>
                                                                                <td
                                                                                    style="width: 25%; text-align: left; padding-left: 33px; font-weight: 500;">
                                                                                    Class:</td>
                                                                                <td
                                                                                    style="width: 28%; text-align: left;">
                                                                                    {{ $classWiseStudent['class_name_data']['title'] ?? '' }}
                                                                                </td>
                                                                                <td
                                                                                    style="width: 20%; text-align: left; font-weight: 500;">
                                                                                    Section:</td>
                                                                                <td
                                                                                    style="width: 10%; text-align: left;">
                                                                                    {{ $classWiseStudent['classroom']['section_title'] ?? '' }}
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <td
                                                                        style="width: 100%; padding-top: 11px; padding-left: 20px;">
                                                                        <table style="width: 200px;">
                                                                            <tbody>
                                                                                <tr>

                                                                                    <td
                                                                                        style="width: 100%; font-size: 12px; font-family: 'Roboto'; font-weight: 400; padding-top: 0px; padding-left: 22px; text-align: left; color: #000; max-height: 14px; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 1; line-height: 14px; -webkit-box-orient: vertical; overflow: hidden;">
                                                                                        Guardian:
                                                                                        {{ $classWiseStudent['father']['first_name'] ?? '' }}
                                                                                        {{ $classWiseStudent['father']['middle_name'] ?? '' }}
                                                                                        {{ $classWiseStudent['father']['last_name'] ?? '' }}
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>

                                                                                    <td
                                                                                        style="width: 100%; font-size: 12px; font-family: 'Roboto'; font-weight: 400; padding-top: 0px; padding-left: 27px; text-align: left; color: #000;">
                                                                                        Contact :
                                                                                        {{ $classWiseStudent['father']['phone'] ?? '' }}
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>

                                                                                    <td
                                                                                        style="width: 100%; font-size: 12px; font-family: 'Roboto'; font-weight: 400; padding-top: 0px; padding-left: 38px; text-align: left; color: #000;">
                                                                                        Address :
                                                                                        <span
                                                                                            style="width: 100%; font-size: 9px; font-family: 'Roboto'; font-weight: 400; padding-top: 0px; padding-left: 0; text-align: left; color: #000; max-height: 54px; max-width: 143px; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 4; line-height: 10px; -webkit-box-orient: vertical; overflow: hidden;">
                                                                                            {{ $classWiseStudent['present_address'] ?? '' }}
                                                                                        </span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                            ...
                                            @endforeach
                                        @elseif (count($individualStudentData) > 0)
                                            @foreach ($individualStudentData as $classWiseStudent)
                                                @if (isset($classWiseStudent[0]))
                                                    <li>
                                                        <div
                                                            style="background-size: cover; width: 2.125in; height: 3.375in; overflow: hidden; border: 1px solid #000;">
                                                            ...
                                                            <table style="width: 100%;">
                                                                ...
                                                                <tr>
                                                                    <td style="width: 20%">
                                                                        <img width="80"
                                                                            src="{{ $classWiseStudent[0]['school_logo']['path'] ?? '' }}"
                                                                            alt="School">
                                                                    </td>
                                                                    <td
                                                                        style="width: 80%;color: black;font-weight: 800;font-family: roboto;line-height: 15px;font-size: 13px;">
                                                                        {{ $classWiseStudent[0]['school_data']['title'] ?? '' }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td
                                                                ...
                                                                <tr>
                                                                    <td
                                                                        style="text-align: center; font-size: 10px; padding-left: 45px; line-height: 3px;">
                                                                        Ph. :
                                                                        {{ $classWiseStudent[0]['school_data']['phone'] ?? '' }}
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            ...
                                                            <table
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            style="background-size: cover; height: 81px; width: 40%;">
                                                                            @if ($classWiseStudent[0]['student_image'] && $classWiseStudent[0]['student_image']['path'])
                                                                                <img src="{{ $classWiseStudent[0]['student_image']['path'] ?? '' }}"
                                                                                    alt="student profile picture"
                                                                                    style="height: 74px; width: 65px; border-radius: 3px; padding-left: 2px; padding-top: 13px;">
                                                                            @else
                                                                                <svg style="margin-bottom:13px;"
                                                            ...
                                                            <table
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td
                                                                            style="text-align: center; font-size: 11px; padding-top: 20px; font-weight: 600;padding-left: 15px">
                                                                            {{ $classWiseStudent[0]['first_name'] ?? '' }}
                                                                            {{ $classWiseStudent[0]['middle_name'] ?? '' }}
                                                                            {{ $classWiseStudent[0]['last_name'] ?? '' }}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <table
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td
                                                                                        style="width: 28%; text-align: left;">
                                                                                        {{ $classWiseStudent[0]['class_name_data']['title'] ?? '' }}
                                                                                    </td>
                                                                                    <td
                                                                                        style="width: 20%; text-align: left; font-weight: 500;">
                                                                                        Section:</td>
                                                                                    <td
                                                                                        style="width: 10%; text-align: left;">
                                                                                        {{ $classWiseStudent[0]['classroom']['section_title'] ?? '' }}
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td
                                                                                            style="width: 100%; font-size: 12px; font-family: 'Roboto'; font-weight: 400; padding-top: 0px; padding-left: 22px; text-align: left; color: #000; max-height: 14px; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 1; line-height: 14px; -webkit-box-orient: vertical; overflow: hidden;">
                                                                                            Guardian:
                                                                                            {{ $classWiseStudent[0]['father']['first_name'] ?? '' }}
                                                                                            {{ $classWiseStudent[0]['father']['middle_name'] ?? '' }}
                                                                                            {{ $classWiseStudent[0]['father']['last_name'] ?? '' }}
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td
                                                                                            style="width: 100%; font-size: 12px; font-family: 'Roboto'; font-weight: 400; padding-top: 0px; padding-left: 27px; text-align: left; color: #000;">
                                                                                            Contact :
                                                                                            {{ $classWiseStudent[0]['father']['phone'] ?? '' }}
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td
                                                                                            ...
                                                                                            <span
                                                                                                style="width: 100%; font-size: 9px; font-family: 'Roboto'; font-weight: 400; padding-top: 0px; padding-left: 0; text-align: left; color: #000; max-height: 54px; max-width: 143px; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 4; line-height: 10px; -webkit-box-orient: vertical; overflow: hidden;">
                                                                                                {{ $classWiseStudent[0]['present_address'] ?? '' }}
                                                                                            </span>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                            ...
                                            @endforeach
                                        @else
                                            <span style="color: red; font-size:30px;">Studnet not found of this
                                                class</span>
                                        @endif
                                    </ul>
                                </th>
