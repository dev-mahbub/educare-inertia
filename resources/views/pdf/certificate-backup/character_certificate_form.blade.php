...
<head>
    ...
    <meta charset="UTF-8">
    <title>Charachter Certificate</title>
    <style>
        * {
            font-size: 12px;
            font-family: 'Inter';
...
<body>
    ...
    <div class="MainBody" style="border:2px solid;">
                                        ...
                                        <tr>
                                            <td colspan="3"
                                                ...
                                                @if ($schoolImage && $schoolImage['path'])
                                                    <img src="{{ asset('storage/' . $schoolImage['path'] ?? '') }}"
                                                        style="width: 85px; height: 80px; margin-top: 0px;" />
                                                @else
                                                    <svg width="85" height="80" viewBox="0 0 80 80"
                                    ...
                                    <table>
                                        <tr>
                                            <th colspan="3"
                                                ...
                                                <span
                                                    style="width: 100%; text-align: center; font-weight: 600; font-size: 28px;color: black">{{ $school->title ?? '' }}</span>
                                            </th>
                                        </tr>
                                        <tr>
                                            <th colspan="3"
                                                style="width: 100%; text-align: center; font-weight: 400; font-size: 14px;">
                                                <span style="font-size: 18px">
                                                    {{ $school->street_address ?? '' }},
                                                    {{ $school->city ?? '' }} {{ $student->country->name ?? '' }},
                                                    {{ $school->zip ?? '' }}
                                                </span><br />
                                                <span style="font-size: 18px">Ph : {{ $school->phone }}, Email :
                                                    {{ $school->mail }}</span><br />
                        ...
                        <table>
                            <tr>
                                <td class="" style="width: 100%; text-align: center; padding-left: 190px;">
                                    <h3 class="dte"
                                        style="font-size: 20px; text-decoration: underline; margin-top: 10px; margin-bottom: 3px; font-weight: 600; text-align: center;">
                                ...
                                <td class="imgborder">
                                    @if ($studentImage && $studentImage['path'])
                                        <img src="{{ $studentImage['path'] }}"
                                            style="height: 100px; width: 100px; margin-bottom: 20px;" />
                                    @else
                    ...
                    <td class="" style="width:100%;padding-left: 43px;padding-right: 37px;">
                        ...
                        <h3
                            ...
                            <span contenteditable="true"
                                style="text-transform: uppercase; font-size: 18px; font-weight: 600; color: #000; font-family: 'Inter' !important; padding: 0 4px;">
                                {{ $student->first_name ?? '' }}
                                {{ $student->middle_name ?? '' }}
                                {{ $student->last_name ?? '' }}
                            </span>
                            ...
                            <span
                                style="font-weight: normal; font-size: 20px; color: #222; font-family: 'Inter' !important;">has
                                been a bonafide student of</span>
                            <span contenteditable="true"
                                style="text-transform: uppercase; font-size: 18px; font-weight: 600; color: #000; font-family: 'Inter' !important; padding: 0 4px;">
                                {{ $school->title ?? '' }}
                            </span>
                            <span
                                ...
                                to</span>
                            <span contenteditable="true"
                                style="text-transform: uppercase; font-size: 18px; font-weight: 600; color: #000; font-family: 'Inter' !important;"></span>
                            <span
                                style="font-weight: normal;font-size: 20px;color: #222;font-family: 'Inter' !important;">He/She
                                has been passed</span>
                            <span contenteditable="true"
                                style="text-transform: uppercase; font-size: 18px; font-weight: 600; color: #000; font-family: 'Inter' !important; padding: 0 4px;">
                                {{ $student->classroom->title ?? '' }}
                            </span>
                            <span
                                style="font-weight: normal; font-size: 20px; color: #222; font-family: 'Inter' !important;">in
                                academic session</span>
                            <input id="IssueYear" name="IssueYear"
                                style="border: none; width: 75px; font-weight: 600; font-size: 15px; font-family: Roboto; border-bottom: 1px dotted #000;"
                                type="text"
                                value="{{ $student->classroom->academicYear->academic_session ?? '' }}" />
                            <span
                                style="font-weight: normal; font-size: 20px; color: #222; font-family: 'Inter' !important;">with
                                Admission Number</span>
                            <span contenteditable="true"
                                style="text-transform: uppercase; font-size: 18px; font-weight: 600; color: #000; font-family: 'Inter' !important;">
                                {{ $student->admission_no ?? '' }}
                                .</span>
                        </h3>
                        <h3
                            style="line-height: 29px;text-align: justify;letter-spacing: 0px;font-family: 'Inter' !important;text-decoration: none !important;">
                            <span contenteditable="true"
                                style="text-transform: uppercase;letter-spacing: 1px;font-size: 18px;font-weight: 600;color: #000;font-family: 'Inter' !important;
                                padding: 0 4px;">
                                {{ $student->first_name ?? '' }}
                                {{ $student->middle_name ?? '' }}
                                {{ $student->last_name ?? '' }}
                            ...
                            <span contenteditable="true"
                                ...
                                a silent and hard working student who is able to identify her strength and
                                weaknesses.</span>
                        </h3>
                        <h3
                            style="line-height: 29px;text-align: justify;letter-spacing: 0px;font-family: 'Inter' !important;text-decoration: none !important;">
                            ...
                            <span
                                style="font-weight: 700;font-size: 20px;color: #222;font-family: 'Inter' !important;">To
                                the best of my knowledge and belief, she bears a good moral character. I wish her all
                                the best in her future plans and endeavors.</span>
                        </h3>
                    </td>
                </tr>
            </tbody>
        ...
        <table class="maintable" style="margin-top:30px;">
            <tbody>
                <tr>
                    <td class="" style="width:100%;text-align:left;padding-left: 49px;font-size: 18px;">
                        Date: {{ date('d-m-Y', strtotime(now() ?? '')) }}</td>
                    <td class="" style="width: 100%; text-align: right; padding-left: 49px;">
                        <h3 class="dte"
                            style="margin-bottom: 0; color: #222; font-size: 20px; line-height: 19px; text-align: left; padding: 0px 33px 0px 35px; font-weight: 300; text-decoration: none; ">
                            Principal/Manager
                        </h3>
                    </td>
    ...
    <script language="javascript" type="text/javascript">
        $(function() {
            ...
            $("#btnGenerateTC").click(function() {
                ...
                if (result == true) {
                    $.ajax({
                        url: '{{ route('student_character_certificate_save') }}',
                        data: {
