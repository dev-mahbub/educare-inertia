...
<body>
    @if ($student != null)
    <table style="width: 100%; font-family: 'Inter', sans-serif; padding-top: 5px; padding-bottom: 5px; border-bottom: 0;">
        <thead>
            <tr style="width: 100%;">
                <td style="width: 10%; vertical-align: top; text-align: left;">
                    <img src="{{ $schoolData['logo']['path'] ?? '' }}" style="width: 85px; height: 80px; margin-top: 0px;" />
                </td>
                ...
                <td style="width: 10%; vertical-align: top; text-align: right;">
                    <img src="{{ $student['studentImage']['path'] ?? '' }}" style="width: 85px; height: 80px; margin-top: 0px;" />
                </td>
            </tr>
        </thead>
    </table>
    <table class="table-border" style="width: 100%;margin-top:5px;">
        ...
        <tbody>
            ...
            <tr style="width: 100%; vertical-align:top;">
                ...
                <td style="font-size: 11px; font-weight: 400; width: 50%;padding:7px;">
                    Category : <span style="font-weight: bold">{{ __($student?->student_category?->category?->title) }}</span>
                </td>
            </tr>
            <tr style="width: 100%; vertical-align:top;">
                <td style="font-size: 11px; font-weight: 400; width: 50%;padding:7px;">
    ...
    <table class="table-border" style="width: 100%; margin-top:5px;">
        ...
        <tbody>
            ...
            <tr style="width: 100%; vertical-align:top;">
                <td style="font-size: 11px; font-weight: 400; width: 50%;padding:7px;">
                    Highest Qualification : <span style="font-weight: bold">{{ __($student?->father?->highest_qualification) }}</span>
                </td>
                <td style="font-size: 11px; font-weight: 400; width: 50%;padding:7px;">
                    Highest Qualification : <span style="font-weight: bold">{{ __($student?->mother?->highest_qualification) }}</span>
                </td>
            </tr>
            <tr style="width: 100%; vertical-align:top;">
                <td style="font-size: 11px; font-weight: 400; width: 50%;padding:7px;">
            ...
            <tr style="width: 100%; vertical-align:top;">
                <td style="font-size: 11px; font-weight: 400; width: 50%;padding:7px;">
                    Income Per Year : <span style="font-weight: bold">{{ __($student?->father?->income_per_year) }}</span>
                </td>
                <td style="font-size: 11px; font-weight: 400; width: 50%;padding:7px;">
                    Income Per Year : <span style="font-weight: bold">{{ __($student?->mother?->income_per_year) }}</span>
                </td>
            </tr>
            <tr style="width: 100%; vertical-align:top;">
                <td style="font-size: 11px; font-weight: 400; width: 50%;padding:7px;">
            ...
            <tr style="width: 100%; vertical-align:top;">
                <td style="font-size: 11px; font-weight: 400; width: 50%;padding:7px;">
                    Office address : <span style="font-weight: bold">{{ __($student?->father?->office_address) }}</span>
                </td>
                <td style="font-size: 11px; font-weight: 400; width: 50%;padding:7px;">
                    Office address : <span style="font-weight: bold">{{ __($student?->mother?->office_address) }}</span>
                </td>
            </tr>
        </tbody>
    </table>
