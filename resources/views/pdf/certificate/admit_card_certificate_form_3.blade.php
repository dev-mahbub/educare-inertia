                                            ...
                                            <tr>
                                                <th style="border: 1px solid #d2cbcb; padding:5px 10px 5px;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="vertical-align: middle; text-align: center;">
                                                                <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    <tr>
                                                                        <td style="font-weight: 500; padding-top: 5px"><span style="text-decoration: underline;">ADMIT CARD</span> ({{ __($schoolData['academic_year'] ?? '') }})</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="text-decoration: underline; padding: 5px 0 10px; font-weight: 500">{{ __("EXAM-".($exam['title'] ?? '')) }}</td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                                ...
                                                                <table style="width: 100%;">
                                                                    <tr>
                                                                        <td>
                                                                            <table style="width: 100%;">
                                                                                <tr>
                                                                                    <td style="font-weight: 500; width: 30%; font-size: 12px">Class :</td>
                                                                                    <td style="font-size: 12px;">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <table style="width: 100%;">
                                                                                <tr>
                                                                                    <td style="font-weight: 500; width: 30%; font-size: 12px">Roll :
                                                                                    </td>
                                                                                    <td style="font-size: 12px;">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <table style="width: 100%;">
                                                                                <tr>
                                                                                    <td style="font-weight: 500; width: 30%; font-size: 12px">Phone :
                                                                                    </td>
                                                                                    <td style="font-size: 12px;">
                                                    ...
                                                    <table style="width: 100%; margin-top: 0px; padding: 5px;" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td style="vertical-align:bottom; width: 54.3%; text-align: left; font-size: 14px; font-weight: 700;">
                                                                <span>Acc. Dept's Signature</span>
                                                            </td>
                                                            <td style="vertical-align:bottom; width: 33.3%; text-align: center; font-size: 14px; font-weight: 700;">
