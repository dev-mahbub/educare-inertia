                ...
                <thead>
                    ...
                    <tr class="educare-printarea">
                        <th colspan="3"
                            ...
                            <input type="button" value="TC Generate" id="educare-tc-generate-btn"
                                style="color: #fff; background: #0b52bd; border:0px; padding: 5px 9px; margin-right: 5px; border-radius: 3px; text-decoration: none;" />
                            <input type="submit" value="Save Draft" id="btnDraftTC"
                                    ...
                                    <tr>
                                        <td style="width:120px;padding-left: 15px;">
                                            ...
                                            @if ($student['school_logo'] && $student['school_logo']['path'])
                                                <img src="{{ $student['school_logo']['path'] ?? '' }}"
                                        ...
                                        <td style="width:95%">
                                            ...
                                            <p style="margin: 0;font-size: 14px;font-weight: 300;">
                                                {{ $student['school_data']['street_address'] ?? '' }},
                                                {{ $student['school_data']['city'] ?? '' }}
                                                {{ $student['country']['name'] ?? '' }},
                                                {{ $student['school_data']['zip'] ?? '' }}
                                            </p>
                                            <p style="margin: 0;font-size: 14px;font-weight:300;">
                                                {{ $student['school_data']['phone'] ?? '' }} , {{ $student['school_data']['mail'] ?? '' }}
                                            </p>
                                        </td>
                                    </tr>
                                </tbody>
                                ...
                                <tbody>
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width: 25%; padding: 0 10px; text-align: center;">
                                            ...
                                            <span>
                                                <input id="educare-adm-no" maxlength="20"
                                                    name="educare-adm-no"
                    ...
                    <tr>
                        <th colspan="3"
                            style="width:100%;text-align:justify;font-size:13px;color: rgb(33, 33, 33); padding:7px 13px 13px;font-weight:400;">
                            ...
                            <table style="width:100%;margin-top: 0px;padding-left: 15px;" class="educare-listinfo"
                                ...
                                <tbody>
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="educare-student-name" maxlength="50"
                                                    name="educare-student-name"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="MotherName" maxlength="50"
                                                    name="MotherName"
                                                    style="text-align: left;border: none;float: left;width: 454px;font-size:15px;"
                                                    type="text"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="FatherName" maxlength="50"
                                                    name="FatherName"
                                                    style="text-align: left;border: none;float: left;width: 454px;font-size:15px;"
                                                    type="text"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="DobInFigure" maxlength="50"
                                                    name="DobInFigure"
                                                    style="text-align: left;border: none;float: left;width: 454px;font-size:15px;"
                                                    type="text" value="{{ $birthDate }}" />
                                            </div>
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="DobInWords1" maxlength="50"
                                                    name="DobInWords1"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="LastSchoolAttended" maxlength="50"
                                    ...
                                    <tr style="vertical-align: top;">
                                        ...
                                        <td style="width: 46%; padding: 0 10px; text-align: left; font-weight: 400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="GenderName" maxlength="50"
                                                    name="GenderName"
                                                    style="text-align: left;border: none;float: left;width: 454px;font-size:15px;"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="Religion" maxlength="50"
                                                    name="Religion"
                                                    style="text-align: left;border: none;float: left;width: 454px;font-size:15px;"
                                                    type="text" value="" />
                                            </div>
                                            ...
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="Caste" maxlength="50"
                                                    name="Caste"
                                                    style="text-align: left;border: none;float: left;width: 454px;font-size:15px;"
                                                    type="text" value="" />
                                            </div>
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="PlaceOfBirth" maxlength="50"
                                                    name="PlaceOfBirth"
                                                    style="text-align: left;border: none;float: left;width: 454px;font-size:15px;"
                                                    type="text" value="" />
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="AdmissionDate" maxlength="50"
                                                    name="AdmissionDate"
                                                    style="text-align: left;border: none;float: left;width: 454px;font-size:15px;"
                                                    type="text" value="" />
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="ClassSection" maxlength="50"
                                                    name="ClassSection"
                                                    style="text-align: left;border: none;float: left;width: 454px;font-size:15px;"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="SubjectsStudied" maxlength="70"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="PreviousSchoolBoardExamResult"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="WhetherQualified" maxlength="50"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="PromotedToClass" maxlength="50"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="MonthuptowhichPupilPaidFees"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="AnyFeesAvailedofConcession"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="TotalNumberofWorkingDays" maxlength="50"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="TotalNumbersofPresentDays"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="WhetherInNccScout" maxlength="50"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="GamesPlayedOtherActivity" maxlength="50"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="GeneralConduct" maxlength="50"
                                                    name="GeneralConduct"
                                                    style="text-align: left;border: none;float: left;width: 454px;font-size:15px;"
                                                    type="text" value="need to update" />
                                    ...
                                    <tr style="vertical-align: top;">
                                        ...
                                        <td style="width: 46%; padding: 0 10px; text-align: left; font-weight: 400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="DateofIssueofCertificate" maxlength="50"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="ReasonforLeavingtheSchool"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:50%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="Address1" maxlength="50"
                                                    name="Address1"
                                    ...
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:46%;padding:0 10px;text-align:left;font-weight:400;">
                                            <div style="height: 15px;">
                                                <input class="educare-300" id="AnyOtherRemarks1" maxlength="150"
                                                ...
                                                <tbody>
                                                    <tr style="vertical-align:top;">
                                                        ...
                                                        <td
                                                            ...
                                                            <input class="educare-300" id="txtCoordinator"
                                ...
                                <tbody>
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td class="" style="width:60%;text-align:center;">
                                            <div style="height: 15px;">
                                                <input id="educare-student-name" maxlength="90" name="educare-student-name"
                                                    style="text-align: left;border: none;border-bottom: 1px dotted #000;float: left;width: 454px;"
                                                    type="text"
                                                    value="{{ optional($student)->first_name ?? '' }} {{ optional($student)->middle_name ?? '' }} {{ optional($student)->last_name ?? '' }}" />
                                ...
                                <tbody>
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:32%;text-indent:0;text-align:left;">
                                            Date :
                                            <span>
                                                <input id="educare-fill-date" maxlength="60" name="educare-fill-date"
                                                    style="text-align: left;border: none;width: 100px;" type="text"
                                                    value="" />
                                            </span>
                                        </td>
                                ...
                                <tbody>
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td class="" style="text-align:center;">
                                            <div style="height: 15px;">
                                                <input id="educare-son-daughter" maxlength="60" name="educare-son-daughter"
                                                    style="text-align: left;border: none;border-bottom: 1px dotted #000;float: left;width: 454px;"
                                                    type="text"
                                                    value="{{ optional($student)->father->first_name ?? '' }} {{ optional($student)->father->middle_name ?? '' }} {{ optional($student)->father->last_name ?? '' }}" />
                                ...
                                <tbody>
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td class="" style="width:20%;float:left;text-align:center;">
                                            <div style="height: 15px;">
                                                <input id="educare-adm-no" maxlength="25"
                                                    name="educare-adm-no"
                                                    style="text-align: left;border: none;border-bottom: 1px dotted #000;float: left;width: 454px;"
                                            ...
                                            <table style="width:100%;">
                                                <tbody>
                                                    ...
                                                    <tr style="vertical-align:top;">
                                                        ...
                                                        <td class="" style="text-align:center;">
                                                            <div style="height: 15px;">
                                                                <input class="educare-300" id="DobInWords1"
                                                                    maxlength="50" name="DobInWords1"
                                                                    style="text-align: left;border: none;float: left;width:410px !important;"
                                                                    type="text"
                                ...
                                <tbody>
                                    <tr style="vertical-align:top;">
                                        ...
                                        <td style="width:32%;text-indent:0;text-align:left;">
                                            ...
                                            <span>
                                                <input id="educare-fill-date" maxlength="50" name="educare-fill-date"
                                                    style="text-align: left;border: none;width: 100px;" type="text"
                                                    value="" />
                                    ...
                                    <table style="width:100%;">
                                        <tr style="vertical-align:top;">
                                            <th colspan="3"
                                                style="width:100%;text-align:center;font-weight:400;font-size:19px;line-height: 8px;margin-top:20px;">
                                                NO DUES CERTIFICATE
                                            </th>
                                        </tr>
                                    </table>
    ...
    <script language="javascript" type="text/javascript">
        $(function() {
            ...
            $("#educare-tc-generate-btn").click(function() {
                ...
                if (result == true) {
                    $.ajax({
                        url: '{{ route('student_certificate_generate_tc_save') }}',
                        data: {
            ...
            $("#btnDraftTC").click(function() {
                ...
                if (result == true) {
                    $.ajax({
                        url: '{{ route('student_certificate_generate_tc_draft_save') }}',
                        data: {
                            student_id: {{ $student->id }},
                            classroom_id: {{ $student->classroom_id }}
                        },
