                    ...
                    <tr style="width:100%;">
                        ...
                        <td style="width:70%; vertical-align:middle;">
                            <table style="text-align:center; width:100%">
                                <tr>
                                    <td>
                                        <h1 style="margin: 0; font-size:24px;">{{ $school->title }}</h1>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        ...
                        <td style="width:70%;">
                            <table style="text-align:center; width:100%">
                                <tr>
                                    <td>
                                        <h2 style="margin: 0; font-size:16px;">{{ __($school?->academic_year) }}</h2>
                                    </td>
                                </tr>
                                <tr>
                ...
                <tfoot>
                    <tr>
                        <td style="margin:0; padding:0; width:50%; text-align:left;">
                            <h4 style="margin: 0; font-size:12px">Note:</h4>
                    ...
                    <tr>
                        ...
                        <td style="width:70%;">
                            <table style="text-align:center; width:100%">
                                ...
                                <tr>
                                    <td style="width: 100%; padding-top:5px; padding-bottom:5px; border:1px solid #ddd; display:inline-block; background-color:#efefef;">
                                        <h3 style="margin: 0;">{{ __('Reg. Receipt (Office Copy)') }}</h3>
                                    </td>
                                </tr>
                            </table>
                        </td>
