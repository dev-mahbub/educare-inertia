...
import EPFCalculatorPopupForm from "./EPFCalculatorPopupForm";

const EPFCalculatorFilter = ({
    paymentMonths,
    earningTypes,
                            ...
                            <div className='educare-filter-action-btn flex flex-wrap gap-2'>
                                <div>
                                    <Tooltip
                                        ...
                                        as="button"
                                    >
                                        <button onClick={handleListPopupClick}
                                            href="#"
                                ...
                                {totalReportCount > 0 &&
                                    <div>
                                        ...
                                        >
                                            <a
                                                target="_blank"
                                                href={route('pdf_salary.epf_report', params)}
...
export default EPFCalculatorFilter;
