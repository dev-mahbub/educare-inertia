...
export default function CancelPopup({
    ...
    setSelectedStaffAdvancePayment,
    staffId
}) {
    ...
    // handle approve staff advance payment start
    const handleCancelStaffAdvancePayment = (e) => {
        e.preventDefault();
        ...
        if(data?.cancel_reason == '') {
            ...
            patch(route('salary.advance_payment.cancel', selectedStaffAdvancePayment?.id), {
                onSuccess: () => {
                    closeModal();
    ...
    // handle approve staff advance payment end
                    ...
                    <form onSubmit={cancelPopupData} className="p-[30px] pt-2.5">
                        ...
                        <div className="flex flex-wrap justify-end gap-2.5">
                            ...
                            <PrimaryButton
                                ...
                                type="button"
                                onClick={(e) => {
                                    handleCancelStaffAdvancePayment(e);
                                }}
                            >
                                Ok
                            </PrimaryButton>
