...
export default function CancelPopup({
    ...
    cancelPopup,
    setCancelPopup,
    selectedStaffSalaryPayment,
    setSelectedStaffSalaryPayment,
    formData
}) {
    ...
    const handleCancelStaffSalaryPayment = (e) => {
        e.preventDefault();
        ...
        if(data?.cancel_reason == '') {
            ...
            patch(route('salary.cancel_payment', selectedStaffSalaryPayment?.id), {
                onSuccess: () => {
                    closeModal();

                    const form_data = {
                        staff_id: formData?.staff_id,
                        payment_month_id: formData?.payment_month_id,
                    }
                    ...
                    <form onSubmit={cancelPopupData} className="p-[30px] pt-2.5">
                        ...
                        <div className="flex flex-wrap justify-end gap-2.5">
                            ...
                            <PrimaryButton
                                ...
                                type="button"
                                onClick={(e) => {
                                    handleCancelStaffSalaryPayment(e);
                                }}
                            >
                                Ok
                            </PrimaryButton>
