...
export default function EditStudentTypeForm({ scholarBoardingType, studentsType, studentsTypeId}) {
    ...
    const {
        ...
        title:studentsTypeId?.title ?? "",
        description:studentsTypeId?.description ?? "",
        student_type:studentsTypeId?.student_type ?? "",
    });

    const handleStudentTypeData = (e) =>{
        e.preventDefault();
        put(route("admission.student_type.update",studentsTypeId.id),data, {
            preserveScroll: true,
            onSuccess: () => reset()
        });
    };
                        ...
                        <div className="educare-classroom-table-wrapper">
                            ...
                            <div className="educare-default-table xs:overflow-x-auto mb-[25px]">
                                <table>
                                    ...
                                    <tbody>
                                        {studentsType?.length > 0 ?
                                            studentsType?.map((item, index) => (
                                                <tr key={item?.id}>
                                                    <td>{index+1}</td>
                                                    <td>{item?.title}</td>
                                            ...
                                            <div className="col-span-12">
                                                <div className="flex flex-wrap gap-2.5 mt-2 justify-end">
                                                    <Link
                                                        ...
                                                        href={route('admission.student_type')}
                                                    >
                                                        Cancel
                                                    </Link>
                                                    <PrimaryButton
