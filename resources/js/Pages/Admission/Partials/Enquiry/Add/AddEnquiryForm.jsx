...
const AddEnquiryForm = ({
    ...
    const handleAacademicYearChange = (e) => {
        ...
        router.post(route('admission_enquery_reg.enquiry_form'), { academic_year_id: academic_year_id });
    }
    // handle academic year change end

    const addEnquiryData = (e) => {
        e.preventDefault();
        data.enquiry_date_at = startDate;
        data.date_of_birth = birthDate;
        data.in_time = InTime;
        post(route("admission_enquery_reg.save"), {
            preserveScroll: true,
            onSuccess: () => reset(),
        });
    };
