                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th>Total Adm Taken</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {Object.keys(classWiseAdmissionSummary)?.length > 0 &&
                                        Object.values(classWiseAdmissionSummary)?.map((item, index) => (
                                            <tr key={index}>
                                                ...
                                                <td>
                                                    <button
                                                        ...
                                                        className="cursor-pointer text-primary"
                                                        onClick={() => {
                                                            handleFilterSummaryData(item?.admissions ?? [])
                                                        }}
                                                    >
                                                        {item?.total_admission ?? 0}
                                                    </button>
                                                </td>
                                            </tr>
                                        ))
