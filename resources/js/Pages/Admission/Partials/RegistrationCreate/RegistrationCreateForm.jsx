...
import CheckSiblingPopupForm from "./CheckSiblingPopupForm";

const RegistrationCreateForm = ({
    classNames,
    houses,
    status,
    admissionNumbers,
    ...
    const handelCheckAdmNo = (e) => {
        post(route("student.adn_check"), data, {
            preserveScroll: true,
            onSuccess: () => reset()
        });
    }
                                            ...
                                            <div className="grid grid-cols-12 gap-5">
                                                <div className="col-span-6 max2Xl:col-span-12 minMaxMd:col-span-6">
                                                    <div className="educare-create-school-settings-list educare-create-school-settings-list-document">
                                                        <div className="educare-create-school-settings-list-check width-full">
                                                            <Checkbox
                                                                id="is_computer_option"
                                                                name="is_computer_option"
                                                                checked={
                                                                    data.is_computer_option
                                                                }
                                                                onChange={(e) =>
                                                                    setData(
                                                                        "is_computer_option",
                                                ...
                                                <div className="col-span-6 max2Xl:col-span-12 minMaxMd:col-span-6">
                                                    <div className="educare-create-school-settings-list educare-create-school-settings-list-document">
                                                        <div className="educare-create-school-settings-list-check width-full">
                                                            <Checkbox
                                                                id="is_social_studies_option"
                                                                name="is_social_studies_option"
                                                                checked={
                                                                    data.is_social_studies_option
                                                                }
                                                                onChange={(e) =>
                                                                    setData(
                                                                        "is_social_studies_option",
                                                        ...
                                                        <div className="educare-create-school-settings-list-title width-full">
                                                            <InputLabel
                                                                htmlFor="is_social_studies_option"
