...
export default function EditAdmissionSourceForm({enquirySource, enquerySourceId}) {
    ...
    const {
        ...
        title: enquerySourceId?.title,
        description:enquerySourceId?.description,
    });

    const handleAdmissionSourceData = (e) => {
        e.preventDefault();
        put(route("admission.enquiry_source.update",enquerySourceId.id), data, {
            preserveScroll: true,
            onSuccess: () => reset()
        });
    };
