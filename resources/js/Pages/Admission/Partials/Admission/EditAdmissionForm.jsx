...
import EditSiblingPopupForm from "./Popup/EditSiblingPopupForm";
...
const EditAdmissionForm = ({
    ...
    const [selectedSibling, setSelectedSibling] = useState(registrationData?.sibling ?? {});
    ...
    const { data, setData, errors, put, post, reset, processing } = useForm({
        ...
        selectedSibling: [],
        sibling_id: registrationData?.sibling?.id ?? "",
        academic_year_id: registrationData?.admission_academic_year_id ?? "",
        class_name_id: registrationData?.class_name_id ?? "",
        academic_fee: registrationData?.academic_fee ?? "",
        user_id: registrationData?.user_id ?? "",
        source_id: registrationData?.source_id ?? "",
        reference_by: registrationData?.reference_by ?? "",
        staff_id: registrationData?.staff_id ?? "",
        reference_by_parent: registrationData?.reference_by_parent ?? "",
        reference_by_alumni: registrationData?.reference_by_alumni ?? "",
        employment_category_id: registrationData?.employment_category_id ?? "",
        //payment mode start
        payment_mode: registrationData?.payment_mode ?? "",
        payment_note: registrationData?.payment_note ?? "",
        cheque_date: registrationData?.cheque_date ?? "",
        school_receipt_no: registrationData?.school_receipt_no ?? "",
        keep_same_payment_detail: registrationData?.keep_same_payment_detail ?? "",
        //cheque
        cheque_no: registrationData?.cheque_no ?? "",
        bank_name: registrationData?.bank_name ?? "",
        branch: registrationData?.branch ?? "",
        //Bank Process form
        bank_account_id: registrationData?.bank_account_id ?? "",
        bank_id: registrationData?.bank_id ?? "",
        //Paytm
        paytm_ref_no: registrationData?.paytm_ref_no ?? "",
        paytm_mobile: registrationData?.paytm_mobile ?? "",
        //Neft
        neft_number: registrationData?.neft_number ?? "",
        neft_desc: registrationData?.neft_desc ?? "",
        //UPI
        upi_description: registrationData?.upi_description ?? "",
        upi_number: registrationData?.upi_number ?? "",
        //payment mode end
        ...
        date_of_registration: registrationData?.date_of_registration ?? "",
        form_no: registrationData?.form_no ?? "",
        aadhar_card_no: registrationData?.aadhar_card_no ?? "",
        srn_no: registrationData?.srn_no ?? "",
        child_id: registrationData?.child_id ?? "",
        samagra_id: registrationData?.samagra_id ?? "",
        mother_tongue: registrationData?.mother_tongue ?? "",
        medical_condition: registrationData?.medical_condition ?? "",
        is_physically_disabled: registrationData?.is_physically_disabled ?? "",
        is_special_child: registrationData?.is_special_child ?? "",
        conomically_weaker_section: registrationData?.conomically_weaker_section ?? "",

        // start father info
        father_first_name: registrationData?.father_first_name ?? "",
        father_middle_name: registrationData?.father_middle_name ?? "",
        father_last_name: registrationData?.father_last_name ?? "",
        father_email: registrationData?.father_email ?? "",
        father_mobile: registrationData?.father_mobile ?? "",
        father_sms_number: registrationData?.father_sms_number ?? "",
        father_highest_qualification: registrationData?.father_highest_qualification ?? "",
        father_occupation: registrationData?.father_occupation ?? "",
        father_income_per_year: registrationData?.father_income_per_year ?? "",
        father_department: registrationData?.father_department ?? "",
        father_designation: registrationData?.father_designation ?? "",
        father_aadhar_card_no: registrationData?.father_aadhar_card_no ?? "",
        father_pan_card_no: registrationData?.father_pan_card_no ?? "",
        father_office_address: registrationData?.father_office_address ?? "",
        father_company_name: registrationData?.father_company_name ?? "",
        // end father info

        // start mother info
        mother_first_name: registrationData?.mother_first_name ?? "",
        mother_middle_name: registrationData?.mother_middle_name ?? "",
        mother_last_name: registrationData?.mother_last_name ?? "",
        mother_email: registrationData?.mother_email ?? "",
        mother_mobile: registrationData?.mother_mobile ?? "",
        mother_highest_qualification: registrationData?.mother_highest_qualification ?? "",
        mother_occupation: registrationData?.mother_occupation ?? "",
        mother_income_per_year: registrationData?.mother_income_per_year ?? "",
        mother_department: registrationData?.mother_department ?? "",
        mother_designation: registrationData?.mother_designation ?? "",
        mother_aadhar_card_no: registrationData?.mother_aadhar_card_no ?? "",
        mother_pan_card_no: registrationData?.mother_pan_card_no ?? "",
        mother_company_name: registrationData?.mother_company_name ?? "",
        mother_office_address: registrationData?.mother_office_address ?? "",
        // end mother info
        ...
        permanent_taluka: registrationData?.permanent_taluka ?? "",
        permanent_district: registrationData?.permanent_district ?? "",
        permanent_pin_code: registrationData?.permanent_pin_code ?? "",

        document_attached: [],

        school_name: registrationData?.school_name ?? "",
        school_class: registrationData?.school_class ?? "",
        school_year: registrationData?.school_year ?? "",
        tc_no: registrationData?.tc_no ?? "",
        referred_by: registrationData?.referred_by ?? "",

        boarding_scholar: registrationData?.boarding_scholar ?? "",
        is_transport_availed: registrationData?.is_transport_availed ?? "",

        sibling_name: registrationData?.sibling_name ?? "",
        sibling_std: registrationData?.sibling_std ?? "",
        sibling_adm_no: registrationData?.sibling_adm_no ?? "",
        sibling_year: registrationData?.sibling_year ?? "",
        is_have_sibling: registrationData?.is_have_sibling ?? "",
        ...
        guardian_image: null,
        // extra
        enquiry_guardian_id:registrationData?.enquiry_guardian_id ?? "",
        enquery_fee_id:registrationData?.enquery_fee_id ?? "",
    ...
    const handleAacademicYearChange = (e) => {
        ...
        router.post(route('admission_enquery_reg.edit_registration', registrationData?.id), { academic_year_id: academic_year_id });
    }
    ...
    const handleUpdateData = (e) => {
        ...
        if (hasError == false) {
            ...
            post(route("admission_enquery_reg.update_registration", registrationData.id), {
                preserveScroll: true,
                onSuccess: () => {
                    reset();
                }
                                                        ...
                                                        <div className="educare-student-parent-profile-images-wrap flex flex-wrap gap-x-5 justify-between">
                                                            <div className="educare-student-parent-profile-image w-[47%] maxXs:w-full">
                                                                ...
                                                                <label htmlFor="student_image">
                                                                    <img
                                                                        src={
                                                                            registrationData?.student_image?.path ?? placeholderImage
                                                                        }
                                                                        alt="img not found"
                                                                    />
                                                                </label>
                                                            ...
                                                            <div className="educare-student-parent-profile-image w-[47%] maxXs:w-full">
                                                                ...
                                                                <label htmlFor="father_image">
                                                                    <img
                                                                        src={
                                                                            registrationData?.father_image?.path ?? placeholderImage
                                                                        }
                                                                        alt="img not found"
                                                                    />
                                                                </label>
                                                            ...
                                                            <div className="educare-student-parent-profile-image w-[47%] maxXs:w-full">
                                                                ...
                                                                <label htmlFor="mother_image">
                                                                    <img
                                                                        src={
                                                                            registrationData?.mother_image?.path ?? placeholderImage
                                                                        }
                                                                        alt="img not found"
                                                                    />
                                                                </label>
                                    ...
                                    <div className="educare-school-form-action-title flex flex-wrap justify-between">
                                        ...
                                        <div className="inline-flex gap-5">
                                            ...
                                            {data?.is_have_sibling == true ?
                                                ...
                                                : ""}
                                            {/* {data.is_have_sibling === true ?
                                                <button onClick={(e) => handelCheckSibling(data.is_have_sibling, data.father_first_name, data.father_email, data.father_mobile)} className="educare-secondary-btn-md-stroke" type="button">Add Siblings</button>
                                                : ""} */}
                                        </div>
                                    </div>
                                    <div className="educare-create-school-details-form-wrap-border border-t border-grayLight/20 pt-5">
