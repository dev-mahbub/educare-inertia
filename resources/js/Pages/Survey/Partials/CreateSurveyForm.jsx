...
export default function CreateSurveyForm({ surveyAudience, classNamesData }) {
        ...
        <div className="educare-create-school-area p-[30px] maxXs:p-[15px] rounded-[10px] bg-white/70">
            <form onSubmit={handleInsertData}>
                ...
                <div className="flex flex-wrap gap-2.5 mt-2 justify-end">
                    <Link href={route('survey.create')} className="educare-gray-btn-lg-stroke">
                        Reset
                    </Link>
