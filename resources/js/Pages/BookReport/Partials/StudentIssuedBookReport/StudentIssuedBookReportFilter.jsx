...
const StudentIssuedBookReportFilter = ({
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        setLoading(false);
        router.post(route('book_report.student_issue_book'), data);
    }

    const handleReset = (e) => {
        e.preventDefault();
        setLoading(false);
        router.get(route('book_report.student_issue_book'));
    }
                        ...
                        <form>
                            <div className=" educare-header-filtar-bar-inner-main">
                                ...
                                <div className="educare-header-filtar-bar-count mr-auto">
                                    <span>Book Issued: {studentIssusBookCount}</span>
                                </div>
                                {/* delete count if don't need */}
...
export default StudentIssuedBookReportFilter;
