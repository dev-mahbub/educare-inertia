...
const StudentViewFilter = ({ students, classWorks }) => {
    ...
    const studentChange = (e) => {
        ...
        router.post(route("classwork.view"), updatedData, {
            preserveScroll: true,
        });
    };
                                ...
                                <div className="educare-header-filtar-bar-fields-area relative">
                                    ...
                                    <div className="educare-header-filtar-bar-fields-wrap items-center">
                                        <div className="educare-card-title">
                                            <h5>
                                                Dear sibling, This is the list of your Classwork
                                            </h5>
                                        </div>
...
export default StudentViewFilter;
