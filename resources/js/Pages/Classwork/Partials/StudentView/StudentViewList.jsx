...
const StudentViewList = ({ students, studentId, classWorks }) => {
    ...
    const handleAttachmentsModel = (id, title, class_file) => {
        setAttachmentData({id, title, class_file});
                                                    ...
                                                    <div className="flex gap-2">
                                                        <Tooltip title="Download Attachments" placement="top" arrow>
                                                            <button className="px-3 py-1.5 bg-indigo-800 text-white rounded hover:bg-indigo-600 transition flex items-center gap-1" 
                                                                onClick={() => handleAttachmentsModel(item?.id, item?.title, item?.class_file)}
                                                                type='button'
                                                            >
                                                        ...
                                                        <Tooltip title="Submit Your Work" placement="top" arrow>
                                                            <Link 
                                                                href={route('student.classwork.show', { student_id: studentId, classwork_id: item?.id })} 
