...
export default function EditClassworkForm({ classWork, subjects, classNames, classRoom }) {

    const [startDate, setStartDate] = useState(new Date(classWork.start_date_at));
    const [endDate, setEndDate] = useState(new Date(classWork.end_date_at));
    ...
    const {
        ...
        subject_id: classWork.class_subject_id,
        class_name_id: classWork.class_name_id,
        title: classWork.title,
        description: classWork.description,
        start_date_at: classWork.start_date_at,
        end_date_at: classWork.end_date_at,
        allow_all_class_id: '',
        assigned_to_class: classWork.assigned_to_class,
        allow_submission: classWork.allow_submission,
        class_file: classWork.class_file,
        classroom_ids: [],
    });
    ...
    const handleUpdate = (e) => {
        ...
        put(route("classwork.update", classWork.id), data, {
            preserveScroll: true,
            onSuccess: () => reset()
        });
    };
    ...
    useEffect(() => {
        const initialClassroomIds = classWork.classrooms.map(classroom => classroom.id);
        setData({
            ...data,
    ...
    const handleClassName = (e) => {
        ...
        router.post(route('classwork.edit', classWork.id), { class_name_id: e.target.value })
    }
