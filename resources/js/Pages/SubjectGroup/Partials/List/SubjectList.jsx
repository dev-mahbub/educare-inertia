...
const SubjectList = ({
    ...
    const handleItemClick = (item, parentId, currentId, isOpen, infra_level_type) => {
        ...
        // router.get('/hostel/setup?ids=' + parentString + '&current=' + item.id + '&is_open=' + isOpen + '&type=' + infra_level_type);
        router.get('/academic/subject/groups?ids=' + parentString + '&current=' + item.id + '&is_open=' + isOpen + '&type=' + infra_level_type);
    };
