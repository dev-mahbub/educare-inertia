...
import CourseCategoryEditPopupForm from "./CourseCategoryEditPopupForm";

export default function CourseCategoryForm({ courseCategories }) {
                        ...
                        <div className="educare-classroom-table-wrapper">
                            <div className="educare-card-title">
                                <h5>
                                    ...
                                    Category list <span>(Total : {courseCategories?.length})</span>
                                </h5>
                            </div>
