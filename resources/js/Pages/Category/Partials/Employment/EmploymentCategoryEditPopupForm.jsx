...
export default function EmploymentCategoryEditPopupForm({ editPopupOpen, setEditPopupOpen, editData, emp_cat_types}) {
                                ...
                                <div className="col-span-9 maxXs:col-span-12">
                                    <div className="educare-select-field-styles">
                                        <SelectInput
                                            ...
                                            data={emp_cat_types}
                                            value={data?.sub_category_type}
                                            onChange={(e) => setData({ ...data, sub_category_type: e.target.value })}
                                            type="text"
                                            className="block"
                                            required
                                        />
