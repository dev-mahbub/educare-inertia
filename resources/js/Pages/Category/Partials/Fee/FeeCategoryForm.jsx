...
import FeeCategoryEditPopupForm from "./FeeCategoryEditPopupForm";



export default function FeeCategoryForm({ feeCategories, feeParent }) {
                        ...
                        <div className="educare-classroom-table-wrapper">
                            <div className="educare-card-title">
                                <h5>
                                    ...
                                    Fee Category list <span>(Total : {feeCategories?.length})</span>
                                </h5>
                            </div>
