        ...
        <>
            <div className="educare-input-field-notes mb-5">
                <ul>
                    <li>
                        {" "}
                        <i className="icon-info"></i> Student attendance
                        register view. (TP - Total Present),(BF - Brought
                        Forward), (CM - Cummulative Attendance),(AP - Attendance
                        Percentage)
                    </li>
                </ul>
            </div>
                        ...
                        <form onSubmit={headerTopData}>
                            <div className="educare-header-filtar-bar-inner-main">
                                ...
                                <div className="educare-header-filtar-bar-action educare-filter-action-btn">
                                    ...
                                    <div>
                                        <Tooltip
                                            title="Download Register View Excel"
                                            placement="top"
                                            arrow
                                            as="button"
                                        >
