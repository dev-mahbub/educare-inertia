...
import DateWiseClassAttendanceReportInnerLayout from './Pertials/DateWiseClassAttendanceReport/DateWiseClassAttendanceReportInnerLayout';
const match = '';
const updateIcon = '';
const deleteIcon = '';

export default function DateWiseClassAttendanceReport({
    auth,
    siteData,
    classrooms,
    attendanceDetails,
