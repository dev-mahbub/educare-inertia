...
import InhousePopUp from "./InhousePopUp";
import InhouseInfra from "./InhouseInfra";
import PurchaseLeftFormPopup from "../Purchase/PurchaseLeftFormPopup";
const InhouseForm = ({
    bookTypes = [],
    libraryVendor = [],
    bookCategory = [],
    ...
    const {
        ...
        library_vendor_id: "",
        type_id: "",
        is_allocate_book_location: false,
    });
                                ...
                                <div className="bg-white/70 shadow-[0_2px_10px_0px_rgba(0,0,0,0.08)] p-[30px] pt-[27px] maxXs:p-[15px] rounded-lg mb-5">
                                    {
                                        items?.almirah === "Room-1" ? (
                                            ...
                                            <ul>
                                                <li>{activeItem?.almirah}</li>
                                                <li>{activeItem?.rack}</li>
                                            </ul>
                                        )
                                    }
                                    {/* <ul>
