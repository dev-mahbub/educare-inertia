...
const EditSmsSettingTemplateForm = ({ templates, template, smsAudiences, smsAudienceContexts, smsAudienceTags }) => {
    ...
    const {
        ...
        web_page_message: template.web_page_message,
        use_tagsArr: [],
    });
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        put(route("sms_setting.update_template", template.id), data, {
            preserveScroll: true,
            onSuccess: () => reset()
        });
    };
                                        ...
                                        <div className="grid grid-cols-12 gap-5">
                                            ...
                                            <div className="col-span-12">
                                                <div className="educare-button-field-styles mt-2.5 text-end">
                                                    ...
                                                    <Link className="educare-primary-btn-md-stroke" href={route('sms_setting.create_template')}>
                                                        add new data
                                                    </Link>
                                                </div>
                                            </div>
...
export default EditSmsSettingTemplateForm;
