...
import TeacherTimeTableLists from './TeacherTimeTableLists';
import { useForm } from '@inertiajs/react';
import moment from "moment";

const TeacherTimeTableMain = ({shiftTypes, timetables}) => {
            ...
            return {
                ...
                periods: timetables.map((period) => {
                    ...
                    if (!repeatable_days || !repeatable_days.includes(day)) { 
                        if(startDateDay === day) {
                            return {
                                subject: period?.classroom?.title,
                                teacher: teacherName
                            }
                        }else{
                            return {
