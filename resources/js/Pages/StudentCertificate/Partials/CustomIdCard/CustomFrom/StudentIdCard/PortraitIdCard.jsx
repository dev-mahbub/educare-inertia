    ...
    return (
        <>
            <div
                ...
                style={{ backgroundColor: idCardCertificateData?.background_color ?? "", backgroundImage: `url("${idCardCertificateData?.background_image}")`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}
            >
                <div
                ...
                <div style={{ backgroundImage: `url("${idCardCertificateData?.body_background_image}")`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', height: '100%', backgroundColor: idCardCertificateData?.body?.background_color ?? "" }}>
                    ...
                    >
                        <div className="body-img">
                            <span className='body-img-rotet-text text-identity'>IDENTITY CARD</span>
                            <div className="id-card-user-logo">
                                <img src={IdCardUserLogo} alt="" />
                            </div>
                            <span className='body-img-rotet-text text-academic-year'>ACY  - {idCardCertificateData?.academic_session ?? ""}</span>
                            {/* <span className='body-img-rotet-text text-academic-year'>ACY  - 2023 - 24</span> */}
                        </div>
                        <div className="icon-drop">
                            <i className='icon-Drop'></i>
                            <span className='blood-group font-bold'>AB+</span>
                        </div>
                    </div>
                ...
                {/* backup */}
                {/* <div className="preview-id-student-info style-one">
                    <p className="student-info"><span className='info-name'>CLASS : </span> <span className='info-value'> NURSERY</span></p>
                ...
                <div className="preview-id-student-info">
                    ...
                    <p className="student-info info-address"><span className='info-name'>ADDRESS : </span> <span className='info-value'> VILLAGE-YUVAN PATH, POST - CHATRA, BLOCK- GWALPARA, DISTRICT MADHEPURA, BIHAR, 856364
                    </span></p>
                </div> */}
                ...
                <div
                    ...
                    style={{ backgroundColor: idCardCertificateData?.footer?.background_color ?? "", backgroundImage: `url("${idCardCertificateData?.footer_background_image}")`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center', height: '30px'  }}
                >
