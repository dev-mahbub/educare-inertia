...
export default function FooterBgCardPopup({ className = '', footerCardBgPopup, setFooterCardBgPopup }) {
    ...
    return (
        <>
            <section className={`educare-admission-follow-up-area space-y-6 ${className}`}>
                <Modal show={footerCardBgPopup} onClose={closeModal}>
