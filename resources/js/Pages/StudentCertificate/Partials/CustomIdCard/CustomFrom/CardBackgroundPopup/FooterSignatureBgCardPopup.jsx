...
export default function FooterSignatureBgCardPopup({ className = '', footerSigCardBgPopup, setFooterSigCardBgPopup }) {
    ...
    return (
        <>
            <section className={`educare-admission-follow-up-area space-y-6 ${className}`}>
                <Modal show={footerSigCardBgPopup} onClose={closeModal}>
