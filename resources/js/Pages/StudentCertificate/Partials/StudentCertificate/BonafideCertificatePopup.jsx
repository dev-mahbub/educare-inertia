...
export default function BonafideCertificatePopup({
    bonafidePopupOpen,
    setBonafidePopupOpen,
    classrooms = [],
    studentNames = []
}) {
                    ...
                    <div className="mt-6 flex justify-end">
                        {data?.student_id && (
                            <PrimaryButton type="button" className="educare-primary-btn-md-fill">
                                <a target="_blank" rel="noopener noreferrer" href={route('bonafide_certificate_generator', data?.student_id)}>
                                    Generate
                                </a>
                            </PrimaryButton>
                        )}
