...
const TodaysClassListFilter = ({
    ...
    const handleClassroomChange = (e) => {
        ...
        router.post(route('online_class.list_today'), form_data);
    }
                    ...
                    <form onSubmit={scheduledClassFilterData}>
                        <div className=" educare-header-filtar-bar-inner-main">
                            ...
                            <div className="educare-header-filtar-bar-count mr-auto">
                                <span>
                                    Total: {today_online_class?.length}
                                </span>
                            </div>
                            {/* delete count if don't need */}
                            ...
                            <div className="educare-header-filtar-bar-action educare-filter-action-btn">
                                ...
                                <div>
                                    ...
                                    >
                                        <Link
                                            href={route('online_class.list_today')}
...
export default TodaysClassListFilter;
