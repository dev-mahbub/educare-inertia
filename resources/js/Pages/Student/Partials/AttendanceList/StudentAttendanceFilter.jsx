...
const StudentAttendanceFilter = ({ students, studentId }) => {
    ...
    const studentChange = (e) => {
        ...
        router.post(route("student_attendance_report.attendance_list"), updatedData, {
            preserveScroll: true,
        });
    };
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <Tooltip title="Submit Your Work" placement="top" arrow>
                                                <Link 
                                                    ...
                                                    href={route('student_attendance_report.list')}
