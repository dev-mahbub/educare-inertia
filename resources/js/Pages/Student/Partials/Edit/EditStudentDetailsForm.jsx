...
import ActionHistoryPopup from "./ActionHistoryPopup";
import ParentLoginPopupForm from "./ParentLoginPopupForm";
...
const EditStudentDetailsForm = ({
    ...
    const [parentLoginPopupOpen, setParentLoginPopupOpen] = useState(false);
    const [parentLoginData, setParentLoginData] = useState(fatherUserData);
    const [actionHistoryPopup, setActionHistoryPopup] = useState(false);
    const [actionHistoryPopupData, setActionHistoryPopupData] = useState({
        'created_by': student.created_by,
        'updated_by': student.updated_by,
    });

    // const jsonDocuments = JSON.parse(student.document_attached) ?? [];
    // const jsonDocs = jsonDocuments;
    // jsonDocuments?.map((item, indx) => {
    //     jsonDocs?.push(item.title);
    // });
    ...
    const { data, setData, errors, post, reset, processing } = useForm({
        id: student.id,
        classroom_id: student?.classroom_student?.classroom_id ? student?.classroom_student?.classroom_id : student.classroom_id,
        selectedSibling: [],
        house_id: student.house_id,
        student_house_id: student.student_house_id,
        admission_id: student.admission_id,
        admission_no: student.admission_no,
        admission_date_at: student.admission_date_at,
        roll_no: student.roll_no,
        status: student.student_status,
        is_have_sibling: student.is_have_sibling,
        sibling_student_id: student.sibling_student_id,
        boarding_type: student.boarding_type,
        caste_type: student.caste_type,
        is_computer_option: student.is_computer_option,
        is_social_studies_option: student.is_social_studies_option,
        ...
        birth_date_at: student.birth_date_at,
        ...
        student_bank_account_id: student.student_bank_account_id,
        account_name: student.account_name,
        account_type: student.account_type,
        account_no: student.account_no,
        ifsc_code: student.ifsc_code,
        micr_no: student.micr_no,
        branch_name: student.branch_name,

        admission_class: student.admission_class,
        employment_cat_id: student.employment_cat_id,
        height: student.height,
        weight: student.weight,
        mother_tongue: student.mother_tongue,
        medical_condition: student.medical_condition,
        notes: student.notes,
        is_physical_disabled: student.is_physical_disabled,
        is_spacial_child: student.is_spacial_child,
        is_economically_weaker: student.is_economically_weaker,
        sub_caste: student.sub_caste,

        // start father info
        father_type: "Father",
        father_id: fatherData.id,
        f_first_name: fatherData.first_name,
        f_middle_name: fatherData.middle_name,
        f_last_name: fatherData.last_name,
        f_email: fatherData.email,
        f_phone: fatherData.phone,
        f_sms_phone: fatherData.sms_phone,
        f_highest_qualification: fatherData.highest_qualification,
        f_occupation: fatherData.occupation,
        f_income_per_year: fatherData.income_per_year,
        f_department: fatherData.department,
        f_designation: fatherData.designation,
        f_aadhar_card_no: fatherData.aadhar_card_no,
        f_pan_card_no: fatherData.pan_card_no,
        f_office_address: fatherData.office_address,
        f_company_name: fatherData.company_name,
        ...
        m_first_name: motherData.first_name,
        m_middle_name: motherData.middle_name,
        m_last_name: motherData.last_name,
        m_email: motherData.email,
        m_phone: motherData.phone,
        m_sms_phone: motherData.sms_phone,
        m_highest_qualification: motherData.highest_qualification,
        m_occupation: motherData.occupation,
        m_income_per_year: motherData.income_per_year,
        m_department: motherData.department,
        m_designation: motherData.designation,
        m_aadhar_card_no: motherData.aadhar_card_no,
        m_pan_card_no: motherData.pan_card_no,
        m_office_address: motherData.office_address,
        m_company_name: motherData.company_name,
        ...
        g_first_name: guardianData.first_name,
        g_email: guardianData.email,
        g_phone: guardianData.phone,
        g_relation: guardianData.relation,
        g_highest_qualification: guardianData.highest_qualification,
        g_occupation: guardianData.occupation,
        g_department: guardianData.department,
        g_designation: guardianData.designation,
        g_aadhar_card_no: guardianData.aadhar_card_no,
        g_id_no: guardianData.id_no,
        g_city: guardianData.city,
        g_address: guardianData.address,
        // end guardian info

        present_address: student.present_address,
        present_state: student.present_state,
        present_city: student.present_city,
        present_taluka: student.present_taluka,
        present_district: student.present_district,
        present_pin_code: student.present_pin_code,
        ...
        prev_school_class: student.prev_school_class,
        prev_school_year: student.prev_school_year,
        prev_school_tc_no: student.prev_school_tc_no,
        prev_school_note: student.prev_school_note,
        ...
        optional_subjects: optionalActiveSubjects,
    });
    useEffect(() => {
        setData((prevData) => ({
            ...prevData,
    ...
    useEffect(() => {
        if (student.document_attached != null) {
            ...
            setAttachedFile(studentAttachedDocuments);
        }
    }, [student]);
    ...
    const handleImageChange = (e, image_for) => {
     ...
     const handleClassroomChange = (e) => {
        ...
        //     setFilteredFeeStructures(feeStructures?.filter(item => item?.classroom_ids?.includes(parseInt(e.target.value))));
        // }
        ...
        router.post(route('student.edit', student.id), { classroom_id: e.target.value }, {
            preserveScroll: true
        });
    }
    ...
    const updateStudentData = (e) => {
        ...
        if (hasError == false) {
            post(route("student.update_post"), {
                preserveScroll: true,
                onSuccess: () => reset(),
            });
        }
    ...
    const handleParentLoginPopupOpen = () => {
        setParentLoginPopupOpen(!parentLoginPopupOpen);
    };

    const handleActionHistoryPopup = () => {
        setActionHistoryPopup(!actionHistoryPopup);
    };
    ...
    // const [selectedOptions, setSelectedOptions] = useState(fatherOccupationValue);
    const [selectedOptions, setSelectedOptions] = useState(null);
    
    const fatherOccupationId = student?.father_occupation_id ?? null;
    useEffect(() => {
        if (occupations && fatherOccupationId) {
            const fatherOccupation = occupations.find(item => item.id === fatherOccupationId);
            setSelectedOptions(fatherOccupation);
            setData('father_occupation_id', fatherOccupationId);
        }
    }, [occupations, fatherOccupationId]);
    ...
    const motherOccupationId = student?.mother_occupation_id ?? null;
    useEffect(() => {
        if (occupations && motherOccupationId) {
            const motherOccupation = occupations.find(item => item.id === motherOccupationId);
            setSelectedOptionsMother(motherOccupation);
            setData('mother_occupation_id', motherOccupationId);
        }
    }, [occupations, motherOccupationId]);
    ...
    return (
        <>
            <div className="educare-create-school-area p-[30px] maxXs:p-[15px] rounded-[10px] bg-white/70">
                                            ...
                                            <div className="grid grid-cols-12 gap-5">
                                                ...
                                                <div className="col-span-6 max2Xl:col-span-12 minMaxMd:col-span-6">
                                                    <div className="educare-input-field-styles">
                                                        ...
                                                        />
                                                        <DatePicker
                                                            selected={data?.admission_date_at && new Date(data?.admission_date_at)}
                                                            onChange={(date) =>
                                                                setData(
                                                                    "admission_date_at", date
                                                                )
                                                            }
                                                            showYearDropdown
                                                            showMonthDropdown
                                                ...
                                                <div className="educare-button-field-styles flex items-end min-h-full">
                                                    <TertiaryButton
                                                        type="button"
                                                        disabled={processing}
                                                        onClick={(e) => handelCheckAdmNo(data.admission_no)}
                                                ...
                                                {data.is_have_sibling && <div className="col-span-6 max2Xl:col-span-12 minMaxMd:col-span-6">
                                                    <div className="educare-input-field-styles">
                                                        <SelectInput2
                                                            ...
                                                            data_label="sibling"
                                                            data={stuSibling}
                                                            selectedData={data.sibling_student_id}
                                                            value={
                                        ...
                                        <div className="educare-create-school-details-form-wrap-border border-t border-grayLight/20 pt-5">
                                            <div className="grid grid-cols-12 gap-5">
                                                {optionalSubjects?.map((item, index) => ( 
                                                    <div key={item?.id} className="col-span-6 max2Xl:col-span-12 minMaxMd:col-span-6">
                                                        <div className="educare-create-school-settings-list educare-create-school-settings-list-document">
                                                            <div className="educare-create-school-settings-list-check width-full">
                                                                <Checkbox
                                                                    id={item?.id}
                                                                    name={item?.title}
                                                                    checked={data.optional_subjects?.includes(item?.id)}
                                                                    onChange={(e) => {
                                                                        const updatedSubjects = e.target.checked
                                                                            ? [...(data.optional_subjects || []), item?.id]
                                                                            : data.optional_subjects?.filter(id => id !== item?.id) || [];
                                                                        setData('optional_subjects', updatedSubjects);
                                                                    }}
                                                                />
                                                            </div>
                                                            <div className="educare-create-school-settings-list-title width-full">
                        ...
                        <div className="lg:col-span-6 col-span-12">
                            ...
                            <div className="educare-create-school-details-form-wrap">
                                <div className="bg-white/70 shadow-[0_2px_10px_0px_rgba(0,0,0,0.08)] p-[30px] pt-[25px] maxXs:p-[15px] rounded-lg mb-5">
                                    ...
                                    <div className="educare-create-school-details-form-wrap-border border-t border-grayLight/20 pt-5">
                                        <PrimaryButton
                                            onClick={handleParentLoginPopupOpen}
                                            type="button"
                                        ...
                                        <PrimaryButton
                                            ...
                                            onClick={handleActionHistoryPopup}
                                        >
                                            Action history
                                        </PrimaryButton>
                                    </div>
                ...
                <ParentLoginPopupForm
                    siteData={siteData}
                    student={student}
                    parentLoginPopupOpen={parentLoginPopupOpen}
                    setParentLoginPopupOpen={setParentLoginPopupOpen}
                    parentLoginData={parentLoginData}
                />
                <ActionHistoryPopup
                    actionHistoryPopup={actionHistoryPopup}
                    setActionHistoryPopup={setActionHistoryPopup}
                    actionHistoryPopupData={actionHistoryPopupData}
                />
            </div>
