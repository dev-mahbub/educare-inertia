                                    ...
                                    {assessments?.length > 0 ?
                                        assessments?.map((item, index) => (
                                            <tr key={index}>
                                                <td>{item?.id}</td>
                                                <td>
                                                    {item?.classrooms.map((classroom) => classroom?.title ).join(', ')}
                                                </td>
                                                    ...
                                                    <div className="educare-admission-list-action-btn">
                                                        <div className="educare-list-button-field-styles">
                                                            <Tooltip title="Edit" placement="top" arrow>
                                                                <Link href={route('assessment.edit', item.id)} className="bg-supportingB/80 inline-block">
                                                        ...
                                                        <div className="educare-list-button-field-styles">
                                                            <Dropdown>
                                                                ...
                                                                <Dropdown.Content>
                                                                    ...
                                                                    <Dropdown.Link href={route("assessment.activity", item.id)}>
