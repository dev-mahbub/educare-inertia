...
const StudentPromotedReportFilterTopbar = ({ studentCount, params }) => {
    return (
        <>
                            ...
                            {studentCount > 0 &&
                                <div>
                                    ...
                                    >
                                        <a
                                            target="_blank"
                                            href={route('export_excel.promoted_student_report', params)}
...
export default StudentPromotedReportFilterTopbar;
