...
const EventForm = ({
    ...
    const [startTime, setStartTime] = useState(eventData?.start_time ? new Date(`${new Date().toLocaleDateString()} ${eventData?.start_time}`) : null);
    ...
    const {
        ...
        start_date: eventData?.start_datetime ? new Date(eventData?.start_datetime) : "",
        end_date: eventData?.end_datetime ? new Date(eventData?.end_datetime) : "",
        start_time: eventData?.start_time ? new Date(`${new Date().toLocaleDateString()} ${eventData?.start_time}`) : "",
        event_budget: eventData?.event_budget ? parseFloat(eventData?.event_budget) : "",
    ...
    // handle update event start
    const handleEventUpdate = (e) => {
        e.preventDefault();

        data['_method'] = 'put';

        post(route('event.update', eventData?.id))
    }
    // handle update event end
