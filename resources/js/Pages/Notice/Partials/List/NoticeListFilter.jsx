...
export default function NoticeListFilter({
    ...
    // handle filter notice list data start
    const handleFilternoticeListData = (e) => {
        e.preventDefault();
        ...
        router.post(route('notice.list'), form_data)
    };
    // handle filter notice list data end
                    ...
                    <form onSubmit={CommonHeaderFilterData}>
                        <div className=" educare-header-filtar-bar-inner-main">
                            <div className="educare-admission-filtar-bar-count">
                                <span>Total: {noticeLists?.length}</span>
                            </div>
                                ...
                                <div className="educare-header-filtar-bar-fields-area relative">
                                    ...
                                    <div className="educare-header-filtar-bar-fields-wrap" ref={listRef} style={{ transform: `translateX(-${currentIndex * 120}px)` }}>
                                            <div className="educare-select-field-styles">
                                                <SelectInput
                                                    id="notice_status"
                                                    data_label="All Notice"
                                                    data={noticeStatusArr}
                                                    value={data.notice_status}
                                                    onChange={(e) =>
                                                        setData("notice_status", e.target.value)
                                                    }
                                                    type="text"
                                                    className="block"
                                                />
                                                <InputError
                                                    message={errors.notice_status}
                                                    className="mt-2"
                                                />
                                            </div>
                                            <div className="educare-select-field-styles">
