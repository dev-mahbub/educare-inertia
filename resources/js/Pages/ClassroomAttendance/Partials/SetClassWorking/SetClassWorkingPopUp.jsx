...
const SetClassWorkingPopUp = ({className = '',openModal, setOpenModal}) => {
    const {
        data,
        setData,
        delete: destroy,
                    ...
                    <form onSubmit={singlePopupData} className="p-[30px] pt-2.5">
                        <div className="educare-popup-form-wrapper border-b mb-5 border-border/50">
                            ...
                            <div className="educare-popup-form pt-5 pb-5 maxSm:py-4 flex flex-col gap-3">
                                <p className='text-danger text-center'>Are you sure to make changes in bonus/working days? It will reflect in all section and students of selected class</p>
                            </div>
                        </div>

                        <div className="flex flex-wrap justify-end gap-2.5">
                            <PrimaryButton className="educare-gray-btn-md-stroke" onClick={closeModal}>Cancel</PrimaryButton>
                            <PrimaryButton className="educare-primary-btn-md-fill">Ok</PrimaryButton>
                        </div>
                    </form>
                </Modal>
            </section>
...
export default SetClassWorkingPopUp;
