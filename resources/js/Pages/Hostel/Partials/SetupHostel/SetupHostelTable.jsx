...
export default function SetupHostelTable({
    infraLevels,
    childLevels,
    infraLavelIds,
    infraLavelIdString,
    ...
    //setup hostel table popup start
    const [listPopup, setListPopup] = useState(false);

    const handleListPopupClick = () => {
        setListPopup(!listPopup);
    };
    //setup hostel table popup end
    ...
    const handleSaveData = (index, type) => {
        const indexData = formFields[index];
        if (indexData) {
            router.post('/hostel/setup?ids=' + idsString + '&current=' + currentUrlId + '&is_open=' + isOpen + '&type=' + type, indexData);
...

                        {
                            type == 'Room' ?
                                <PrimaryButton
                                    ...
                                    onClick={(e) => addFields(e, 'Bed')}
                                >
                                    <i className='icon-PlusCircle'></i>Add Bed
                                </PrimaryButton>
                                :
                                <>
                                    <PrimaryButton
                                    ...
                                    >
                                        <i className='icon-PlusCircle'></i>Add label
                                    </PrimaryButton>

                                    <PrimaryButton
                                        className="educare-primary-btn-md-fill"
                                        onClick={(e) => addFields(e, 'Room')}
                                    >
                                        <i className='icon-PlusCircle'></i>Add Room
                                    </PrimaryButton>
                                    ...
                                    >
                                        <i className='icon-PlusCircle'></i> Assign hostel staff
                                    </PrimaryButton>
                                </>
                        }
                                                        ...
                                                        infraType === 'Room' ?
                                                            <div className="educare-input-field-styles">
                                                                <SelectInput
                                                                    ...
                                                                    onChange={(event, value) => handleFormChange(event, index, "room_type", value)}
                                                                    className="block"
                                                                />
                                                            </div>
                                                            :
