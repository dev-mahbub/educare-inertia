...
const SaleReturnReportFilter = ({
    ...
    const handleSearch = (e) => {
        e.preventDefault();
        if (data) {
            router.post(route('sale_return_report.list'), data);
            setLoading(false);
        }
    }

    const handleReset = () => {
        router.get(route('sale_return_report.list'));
    }
                        ...
                        <form>
                            <div className=" educare-header-filtar-bar-inner-main">
                                <div className="educare-header-filtar-bar-count mr-auto">
                                    <span>Total: {saleReturnLength && saleReturnLength}</span>
                                </div>
                                ...
                                <div className="educare-header-filtar-bar-action educare-filter-action-btn">
                                    ...
                                    {saleReturnLength > 0 &&
                                        <div>
                                            ...
                                            >
                                                <a
                                                    href={route('export_excel.inventory.sale_return_report', data)}
                                                    target="_blank"
...
export default SaleReturnReportFilter;
