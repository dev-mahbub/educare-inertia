...
import CategoryProductEditPopupForm from "./CategoryProductEditPopupForm";
import SelectInput from "@/Components/SelectInput";



export default function CategoryProductForm({ categories = [], proParentCats = [] }) {
                        ...
                        <div className="educare-classroom-table-wrapper">
                            <div className="educare-card-title">
                                <h5>
                                    ...
                                    Group list <span>(Total : {categories?.length})</span>
                                </h5>
                            </div>
