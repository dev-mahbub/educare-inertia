...
import UomEditPopupForm from "./VendorEditPopupForm";


export default function VendorForm({ proVendors = [] }) {
    ...
    const handleFormDataInsert = (e) => {
        e.preventDefault();
        post(route("product_vendor.save"), {
            preserveScroll: true,
            onSuccess: () => reset()
        });
    };
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.delete(route('product_vendor.destroy', id));
            }
        });
    }
                        ...
                        <div className="educare-classroom-table-wrapper">
                            <div className="educare-card-title">
                                <h5>
                                    ...
                                    Product vendor List <span>({proVendors?.length})</span>
                                </h5>
                            </div>
