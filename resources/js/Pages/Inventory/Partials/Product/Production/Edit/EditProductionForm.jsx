...
export default function EditProductionForm({ product, products, productTitles = [], vendorTitles = [] }) {
    ...
    const handleFormDataUpdate = (e) => {
        ...
        put(route("product_production.update", product.id), data, {
            preserveScroll: true,
            onSuccess: () => {
                reset()
            ...
            <div className="educare-classroom-form-area">
                <div className="grid grid-cols-12 gap-[20px]">
                    <div className="lg:col-span-6 xl:col-span-6 col-span-12">
                        <ProductionList products={products} productId={product.id} />
                    </div>
                    <div className="lg:col-span-6 xl:col-span-6 col-span-12">
