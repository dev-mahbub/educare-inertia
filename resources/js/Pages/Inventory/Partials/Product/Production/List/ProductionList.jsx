...
const ProductionList = ({ products = [], productId = '' }) => {
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.delete(route('product_production.destroy', id));
            }
        });
    }
    ...
    // handle edit start
    const handleEdit = (id) => {
        router.post(route('product_production.edit'), {id:id});
    }
    // handle edit end
        ...
        <div className="educare-classroom-table-wrapper">
            <div className="educare-card-title">
                <h5>
                    ...
                    Production products <span>({products?.length})</span>
                </h5>
            </div>
                                    ...
                                    <td>
                                        <div className="educare-button-action-field-wrapper flex gap-[5px]">
                                            <div className="educare-button-field-styles">
                                                ...
                                                >
                                                    <Link
                                                        href={route('product_production.edit', item.id)}
                                                    >
