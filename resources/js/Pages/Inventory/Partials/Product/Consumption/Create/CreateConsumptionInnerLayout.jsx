...
import CreateConsumptionForm from "./CreateConsumptionForm";

const CreateConsumptionInnerLayout = ({ products, productTitles, vendorTitles }) => {
    return (
...
export default CreateConsumptionInnerLayout;
