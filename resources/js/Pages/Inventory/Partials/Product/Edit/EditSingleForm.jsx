...
export default function EditSingleForm({
    product,
    products,
    proCats = [],
    proSubCats = [],
    ...
    const [subCatData, setSubCatData] = useState(proSubCats);
    const {
        data,
        setData,
        errors,
        ...
        rate_per_product: product.rate_per_product,
    ...
    const handleFormDataUpdate = (e) => {
        e.preventDefault();
        put(route("single_product.update", product.id), data, {
            preserveScroll: true,
            onSuccess: () => reset()
        });
    };
    ...
    const handleCategory = (catId) => {
        ...
        router.post(route('edit_single_product.list'), { id: product?.id, 'category_id': catId });
    }
