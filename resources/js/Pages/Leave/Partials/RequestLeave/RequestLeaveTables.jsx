...
const RequestLeaveTables = ({
    ...
    // handle save leave request start
    const handleSaveLeaveRequest = (e) => {
        e.preventDefault();

        post(route('leave.save_request'), {
            onSuccess: () => {
                setLeaveDays([]);
                reset();
            },
                    ...
                    <div className="educare-common-card">
                        <div className="bg-white/70 shadow-[0_2px_10px_0px_rgba(0,0,0,0.08)] p-[30px] pt-[27px] maxXs:p-[15px] rounded-lg mb-5">
                            <div className="grid grid-cols-12 gap-5">
                                ...
                                <div className="col-span-12 max2Xl:col-span-12 minMaxMd:col-span-6 sm:col-span-6 md:col-span-6 lg:col-span-6">
                                    <div className="educare-input-field-styles">
                                        ...
                                        <TextInput
                                            id="teacher"
                                            value={`${staff?.first_name ?? ''} ${staff?.middle_name ?? ''} ${staff?.last_name ?? ''}`}
                                            placeHolder=""
                                            disabled={true}
                                            className={`block ${
                                                data.teacher
...
export default RequestLeaveTables;
