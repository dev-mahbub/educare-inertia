...
import DesignationEditPopupForm from "./DesignationEditPopupForm";
import TextareaInput from "@/Components/TextareaInput";


export default function DesignationForm({ designations }) {
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.delete(route('designation.destroy', id));
            }
        });
    }
    ...
    return (
        <>
                        ...
                        <div className="educare-classroom-table-wrapper">
                            <div className="educare-card-title">
                                <h5>
                                    ...
                                    Designation list <span>(Total : {designations?.length})</span>
                                </h5>
                            </div>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        {designations?.length > 0 ?
                                            ...
                                            <tr>
                                                <td className="text-center text-red-500" colSpan="7">Designation not found</td>
                                            </tr>
                                        }
                                    </tbody>
                                </table>
            ...
            <DesignationEditPopupForm editPopupOpen={editPopupOpen} setEditPopupOpen={setEditPopupOpen} editData={editData}></DesignationEditPopupForm>
        </>
    );
}
