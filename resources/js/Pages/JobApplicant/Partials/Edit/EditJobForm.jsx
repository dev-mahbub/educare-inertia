...
export default function EditJobForm({ job, genders, statues }) {
    const [startDate, setStartDate] = useState(new Date(job?.start_date_at));
    const [endDate, setEndDate] = useState(new Date(job?.end_date_at));
    const [interviewDate, setInterviewDate] = useState(
        new Date(job?.interview_date_at)
    );
    ...
    const { data, setData, errors, put, reset, processing } = useForm({
        ...
        vacancy: job?.vacancy,
        gender: job?.gender,
        start_date_at: job?.start_date_at,
        end_date_at: job?.end_date_at,
        qualification: job?.qualification,
        interview_date_at: job?.interview_date_at,
    ...
    const handleUpdate = (e) => {
        ...
        put(route("job.update", job.id), data, {
            preserveScroll: true,
            onSuccess: () => {
                reset();
