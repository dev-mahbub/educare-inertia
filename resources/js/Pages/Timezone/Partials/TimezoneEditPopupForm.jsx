...
export default function TimezoneEditPopupForm({ editPopupOpen, setEditPopupOpen, editData, timezone_array }) {
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        router.patch(route('timezone.update', data.id), data);
        closeModal();
    };
                                ...
                                <div className="col-span-9 maxXs:col-span-12">
                                    <div className="educare-input-field-styles">
                                        <SelectInput2
                                            ...
                                            data={timezone_array}
                                            selectedData={data.standard_timezone_id}
                                            onChange={(e) => setData({ ...data, standard_timezone_id: e.target.value })}
                                            type="text"
