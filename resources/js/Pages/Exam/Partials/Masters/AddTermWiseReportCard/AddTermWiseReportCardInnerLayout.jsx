...
import AddTermWiseReportCard from './AddTermWiseReportCard';

const AddTermWiseReportCardInnerLayout = ({ termExams, termWise }) => {
    return (
...
export default AddTermWiseReportCardInnerLayout;
