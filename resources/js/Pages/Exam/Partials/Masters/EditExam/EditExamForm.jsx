...
export default function EditExamForm({ exam = {}, exams = [], classrooms = [] }) {
    ...
    const [showSelector, setShowSelector] = useState(exam?.classrooms?.length > 0);
    ...
    const {
        ...
        start_date_at: exam.start_date_at,
        end_date_at: exam.end_date_at,
        is_display_on_calender: exam.is_display_on_calender,
        is_registration: exam.is_registration,
    });
    ...
    useEffect(() => {
        setSelectedOptions(exam?.classrooms?.map(item => item));
        setSelectedClassroomIds(exam?.classrooms?.map(item => item.id));
    }, [exam]);
                    ...
                    <div className="lg:col-span-6 xl:col-span-6 col-span-12">
                        <div className="educare-class-form-box-wrapper">
                            <div className="educare-create-school-details-form-wrap">
                                <div className="educare-card-title">
                                    <h5>
                                        <i className="icon-ListBullets"></i>Update Exam
                                    </h5>
                                </div>
                                <div className="educare-class-form-box bg-white/70 shadow-[0_2px_10px_0px_rgba(0,0,0,0.08)] px-[25px] py-[30px] maxXs:p-[15px] rounded-lg">
                                    <form onSubmit={updateExamData}>
                                            ...
                                            <div className="col-span-12">
                                                {showSelector &&
                                                    <div className='educare-multiple-check-item educare-multiple-add-exam-check-item'>
                                                        <ul className="inline-flex gap-1.5">
                                                            {selectedOptions.map((option, index) => (
                                                                <li key={index}>
