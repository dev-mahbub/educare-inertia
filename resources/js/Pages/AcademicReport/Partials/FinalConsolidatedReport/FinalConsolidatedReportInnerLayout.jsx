...
import FinalConsolidatedReportList from './FinalConsolidatedReportList';

const FinalConsolidatedReportInnerLayout = ({
    classrooms,
    examsData,
    examSubjects
}) => {
...
export default FinalConsolidatedReportInnerLayout;
