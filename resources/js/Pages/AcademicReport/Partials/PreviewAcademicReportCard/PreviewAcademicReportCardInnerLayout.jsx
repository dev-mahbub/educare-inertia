...
import PreviewAcademicReportCardForm from './PreviewAcademicReportCardForm';

const PreviewAcademicReportCardInnerLayout = ({
    classrooms = [],
    students = [],
    student
}) => {
...
export default PreviewAcademicReportCardInnerLayout;
