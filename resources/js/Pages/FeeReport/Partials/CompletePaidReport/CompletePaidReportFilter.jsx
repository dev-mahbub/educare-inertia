...
const CompletePaidReportFilter = ({
    ...
    const handleFilterCompletePaidReport = (e) => {
        ...
        if (data?.from_fee_id === "" || data?.to_fee_id === "") {
            ...
            router.post(route('fee_report.complete_paid_report'), data)
        }
    }
                                    ...
                                    {totalReportCount > 0 &&
                                        <div>
                                            ...
                                            >
                                                <a
                                                    target="_blank"
                                                    href={route('export_excel.complete_fee_paid_report', params)}
                                    ...
                                    {totalReportCount > 0 &&
                                        <div>
                                            ...
                                            >
                                                <a
                                                    target="_blank"
                                                    href={route('pdf_fee_demand_slip.complete_fee_paid_report', params)}
...
export default CompletePaidReportFilter;
