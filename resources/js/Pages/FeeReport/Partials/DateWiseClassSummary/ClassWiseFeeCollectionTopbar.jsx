...
const ClassWiseFeeCollectionTopbar = ({
    params,
                ...
                <div className="educare-filter-action-btn inline-flex gap-2">
                    <div>
                        ...
                        >
                            <a
                                target="_blank"
                                href={route('pdf_fee_demand_slip.class_wise_fee_collection_report', params)}
                    ...
                    <div>
                        ...
                        >
                            <a
                                target="_blank"
                                href={route('export_excel.class_wise_fee_collection_report', params)}
...
export default ClassWiseFeeCollectionTopbar;
