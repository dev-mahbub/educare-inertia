                    ...
                    {totalReportCount > 0 &&
                        <div className="educare-filter-action-btn inline-flex gap-2">
                            ...
                            <div>
                                ...
                                >
                                    <a
                                        href={route('export_excel.teacher.student_daily_collection', params)}
                                        target="_blank"
                            ...
                            <div>
                                ...
                                >
                                    <a
                                        href={route('pdf_fee_demand_slip.teacher.student_daily_collection_report', params)}
                                        target="_blank"
                            ...
                            <div>
                                ...
                                >
                                    <a
                                        href={route('export_excel.teacher.student_installment_wise_daily_collection', params)}
                                        target="_blank"
                                        className="educare-success-btn-md-fill"
                                    >
                                        <i className="icon-FileX"></i>
