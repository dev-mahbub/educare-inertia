...
import BloodGroupEditPopupForm from "./BloodGroupEditPopupForm";
import TextareaInput from "@/Components/TextareaInput";



export default function BloodGroupForm({ blood_groups }) {
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.delete(route('blood_group.destroy', id));
            }
        });
    }
    ...
    return (
        <>
                        ...
                        <div className="educare-classroom-table-wrapper">
                            <div className="educare-card-title">
                                <h5>
                                    ...
                                    Blood group list <span>(Total : {blood_groups?.length})</span>
                                </h5>
                            </div>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        {blood_groups?.length > 0 ?
                                            ...
                                            <tr>
                                                <td className="text-center text-red-500" colSpan="7">Blood group not found</td>
                                            </tr>
                                        }
                                    </tbody>
                                </table>
            ...
            <BloodGroupEditPopupForm editPopupOpen={editPopupOpen} setEditPopupOpen={setEditPopupOpen} editData={editData}></BloodGroupEditPopupForm>
        </>
    );
}
