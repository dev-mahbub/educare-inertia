...
const SubjectWiseReportGraphicallyFilter = ({
    exams = [],
    classrooms = [],
    subjects = [],
}) => {
    ...
    const handelSearchFilter = (e) => {
        ...
        if(data?.classroom_id == "" || data?.subject_id == "") {
            ...
            router.post(route("academic_report_graph.subjectwiseoverall"), data);
        }
    };
    ...
    const handleClassroomChange = (id) => {
        ...
        router.post(route("academic_report_graph.subjectwiseoverall"), form_data);
    };
                        ...
                        <div className=" educare-header-filtar-bar-inner-main">
                            <div className="educare-card-title">
                                <h5>
                                    ...
                                    Subject Wise Report Graphically
                                </h5>
                            </div>
                            ...
                            <div className="educare-header-filtar-bar-action educare-filter-action-btn">
                                ...
                                <div>
                                    ...
                                    >
                                        <Link
                                            href={route("academic_report_graph.subjectwiseoverall")}
...
export default SubjectWiseReportGraphicallyFilter;
