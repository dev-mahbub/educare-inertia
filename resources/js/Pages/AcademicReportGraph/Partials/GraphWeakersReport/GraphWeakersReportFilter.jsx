...
const GraphWeakersReportFilter = ({
    exams,
    classrooms,
    subjects
}) => {
    ...
    const handleClassroomChange = (id) => {
        ...
        router.post(route("academic_report_graph.weaker"), form_data);
    };

    const handelSearchFilter = (e) => {
        e.preventDefault();
        router.post(route("academic_report_graph.weaker"), data);
    };
                        ...
                        <div className=" educare-header-filtar-bar-inner-main">
                            ...
                            <div className="educare-header-filtar-bar-action educare-filter-action-btn">
                                ...
                                <div>
                                    ...
                                    >
                                        <Link
                                            href={route("academic_report_graph.weaker")}
...
export default GraphWeakersReportFilter;
