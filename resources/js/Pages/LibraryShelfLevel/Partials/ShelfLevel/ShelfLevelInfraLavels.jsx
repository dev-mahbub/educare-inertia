...
const ShelfLevelInfraLavels = ({ selectedItem, setSelectedItem, librarySelfLevels }) => {
    ...
    console.log(librarySelfLevels, "hi");
                            ...
                            <div className="col-span-12">
                                <div className="educare-shelf-menu">
                                    <ul className="educare-shelf">
                                        {librarySelfLevels && librarySelfLevels.map((menuItem, index) => (
                                            <li
                                                key={index}
