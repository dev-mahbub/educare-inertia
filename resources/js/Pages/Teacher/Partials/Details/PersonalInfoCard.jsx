...
import TeacherImg from "../../../../../images/user/user-1.png"
...
const PersonalInfoCard = () => {
    ...
    const updateTeacherSubjectData = (e) => {
        e.preventDefault();
    ...
    const updateTeacherClassGroupData = (e) => {
        e.preventDefault();
    ...
    return (
        <>
            ...
            <div className="educare-create-school-details-form-wrap">
                <form onSubmit={updateTeacherSubjectData}>
            ...
            <div className="educare-create-school-details-form-wrap">
                <form onSubmit={updateTeacherClassGroupData}>
                    <div className="bg-white/70 shadow-[0_2px_10px_0px_rgba(0,0,0,0.08)] p-[30px] pt-[25px] maxXs:p-[15px] rounded-lg mb-5">
                        <div className="educare-school-form-action-title">
                            <h5>
                                <i className="icon-info"></i>
