...
const StudentTimetableFilter = ({ students = [], schoolShifts, classroomPeriods }) => {
    ...
    const studentTitmetableFilterData = (e) => {
        e.preventDefault();
    };
    ...
    const studentChange = (e) => {
        ...
        router.post(route("student_timetable.list"), updatedData, {
            preserveScroll: true,
        });
    };

    const studentShiftChange = (e) => {
        const updatedData = { ...data, shift_id: e.target.value };
        setData(updatedData);
        ...
        <div className='educare-admission-filtar-bar-area z-[4] relative'>
            <div className="py-3 pt-0 educare-header-filtar-bar-wrap">
                <div className="educare-header-filtar-bar-main">
                    <form onSubmit={studentTitmetableFilterData}>
                            ...
                            <div className="educare-header-filtar-bar-inner-main-wrap ml-auto maxMd:ml-0">
                                <div className="educare-header-filtar-bar-fields-area relative">
                                    ...
                                    <div className="educare-header-filtar-bar-fields-wrap items-center">
                                        ...
                                        <div className="educare-select-field-styles">
                                            <SelectInput
                                                data_label="Select Shift"
                                                data={schoolShifts}
                                                value={data.shift_id}
                                                onChange={(e) => studentShiftChange(e)}
                                                className="block"
                                            />
                                            <InputError
