...
export default function ManageBankAccount({ banks = [], bankAccounts = [], bankAccount = "" }) {

    const { data, setData, errors, processing, post, patch, reset } = useForm({
        account_name: bankAccount.account_name,
        account_display_name: bankAccount.account_display_name,
        account_no: bankAccount.account_no,
        branch_address: bankAccount.branch_address,
        bank_id: bankAccount.bank_id,
    });

    const handleBankAccountDataUpdate = (e) => {
        e.preventDefault();
        patch(route('bank_account.update', bankAccount.id), data, {
            preserveScroll: true,
            onSuccess: ({ props }) => {
                        ...
                        <div className="educare-class-form-box-wrapper">
                            <div className="educare-create-school-details-form-wrap">
                                ...
                                <div className="educare-class-form-box bg-white/70 shadow-[0_2px_10px_0px_rgba(0,0,0,0.08)] px-[25px] py-[30px] maxXs:p-[15px] rounded-lg">
                                    <form onSubmit={handleBankAccountDataUpdate}>
