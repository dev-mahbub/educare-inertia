...
export default function EditSchoolForm({ school, className = "" }) {
    ...
    const {
        ...
        country_id: school.title,
        state_id: school.title,
        timezone_id: school.title,
        city: school.title,
        zip: school.title,
        phone: school.title,
        phone_2: school.title,
        mail: school.title,
        affiliation_no: school.title,
        school_number: school.title,
        udise_code: school.title,
        display_name_board: school.title,
        established_at: school.title,
        medium: school.title,
        board_id: school.title,
        android_app_url: school.title,
        google_business_url: school.title,
        street_address: school.title,
        //
        current_academy_year_id: school.title,
        admission_seed: school.title,
        admission_prefix: school.title,
        admission_postfix: school.title,
        ticket_url: school.title,
        ticket_user_id: school.title,
        ticket_password: school.title,
        create_homework: school.title,

        //checkox start
        teacher_can_reply: school.title,
        teacher_compose: school.title,
        parent_reply: school.title,
        parent_compose: school.title,
        attendance_on_backdate: school.title,
        send_newsletter_parents: school.title,
        send_newsletter_teachers: school.title,
        student_roll_sortable: school.title,
        report_class_wise: school.title,
        can_see_password: school.title,
        biometric_integration_enable: school.title,
        biometeric_attendence_enable: school.title,
        teacher_see_parent_details: school.title,
        show_duplicate_copy_text_on_tc: school.title,
        pay_online_fees_through_either_voucher: school.title,
        do_not_allow_photo_upload_in_app: school.title,
        allow_transport_to_boarding_student: school.title,
        allow_upload_document: school.title,
        is_student_weekly_status_send_to_parent: school.title,
        email_enable: school.title,
        email_enable_a: school.title,
        notification_enable_on: school.title,
        notification_enable_off: school.title,
        image: null,
        //checkox end
    });
