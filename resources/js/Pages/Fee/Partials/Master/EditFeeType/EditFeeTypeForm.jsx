...
export default function EditFeeTypeForm({types = "", type = "", installment_types = "", fee_categories = ""}) {

    const { data, setData, errors, put, reset, processing } = useForm({
        fee_type: type.fee_type,
        installment_type: type.installment_type,
        category_id: type.category_id,
        display_name: type.display_name,
        is_fee_refundable: type.is_fee_refundable,
        is_late_fee: type.is_late_fee,
        is_transport_fee: type.is_transport_fee,
    ...
    const handleFeeTypeUpdate = (e) => {
        e.preventDefault();
        put(route("fee.type.update", type.id), data, {
            preserveScroll: true,
            onSuccess: () => reset(),
        });
    };
                        ...
                        <div className="educare-class-form-box-wrapper">
                            <div className="educare-create-school-details-form-wrap">
                                ...
                                <div className="educare-class-form-box bg-white/70 shadow-[0_2px_10px_0px_rgba(0,0,0,0.08)] px-[25px] py-[30px] maxXs:p-[15px] rounded-lg">
                                    <form onSubmit={handleFeeTypeUpdate}>
