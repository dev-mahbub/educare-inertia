...
export default function SelectClassPopup({ className = '', classPopup, setClassPopup, class_names = [], sendDataToParent, formReset, selectedClassNameIds, setSelectedClassNameIds }) {
