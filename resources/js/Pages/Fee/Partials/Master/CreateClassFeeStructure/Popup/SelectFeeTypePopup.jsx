...
export default function SelectFeeTypePopup({
    className = '',
    checkedAllTypesBoolean,
    setCheckedAllTypesBoolean,
    selectedFeeTypes,
    feeTypePopup,
    setFeeTypePopup,
    feeTypes = [],
    ...
    const handleCheckboxSelect1 = (name, value, selectedItem) => {
    ...
    //handle Checkbox start
    const handleCheckboxAllSelect1 = (name, value) => {
        setCheckedAllTypesBoolean(!checkedAllTypesBoolean);
        let newFormData;
                    ...
                    <form onSubmit={feeTypePopupData} className="p-[30px] pt-2.5">
                        <div className="educare-popup-form-wrapper border-b mb-5 border-border/50">
                            <div className="educare-popup-form-header py-3">
                                <h5>Select Fee Type for ( {feeData?.title} )</h5>
                            </div>
