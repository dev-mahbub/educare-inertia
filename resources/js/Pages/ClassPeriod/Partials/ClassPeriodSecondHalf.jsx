...
import CreatePeriodSecondHalfPopup from "./popup/CreatePeriodSecondHalfPopup";

const ClassPeriodSecondHalf = ({
    convertToLocaleTime,
    schoolPeriods,
    classroomPeriods,
    formData,
                        ...
                        <div className="educare-master-create-periods-title-item">
                            <div className="educare-master-create-periods-title-top flex justify-between items-center mb-[10px]">
                                <div className="educare-master-create-periods-title">
                                    <h5 className="text-[18px] font-semibold text-headingLight">Second Half</h5>
                                </div>
...
export default ClassPeriodSecondHalf;
