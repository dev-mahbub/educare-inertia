...
export default function CreateHomeworkForm({ subjects, classNames, classRoom, homeworkTypes }) {
    ...
    const handleClassName = (event) => {
        ...
        router.post(route('homework.create'), { class_name_id: classNameVal })
    }
    return (
