...
export default function SchoolFilter({ schools = '' }) {
    const [startDate, setStartDate] = useState(new Date());
    const [endDate, setEndDate] = useState(new Date());

    const landmarksInput = useRef();
    const schoolAdminInput = useRef();
                                    ...
                                    <div className="educare-header-filtar-bar-fields-wrap" ref={listRef} style={{ transform: `translateX(-${currentIndex * 120}px)` }}>
                                        ...
                                        <div className="educare-input-field-styles">
                                            <TextInput
                                                ...
                                                value={data.search}
                                                onChange={(e) => setData("admission_search", e.target.value)}
                                                placeHolder="Search"
                                                type="text"
                                                className="block"
                                            />
                                            <InputError message={errors.admission_search} className="mt-2" />
                                        </div>
                                        <div className="educare-select-field-styles">
                                            <SelectInput
                                                data_label="Class"
