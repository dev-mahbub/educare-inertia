...
export default function EditSchoolForm({ className = '', school, timezones, countries, states, boards, durations, academicYears, imageData }) {
    ...
    const [stateData, setStateData] = useState(states?.filter(item => item?.country_id == school.country_id));
    ...
    const {
        ...
        timezone_id: school.timezone_id,
        city: school.city,
        zip: school.zip,
        phone: school.phone,
        ...
        display_name_board: school.display_name_board,
        established_at: school.established_at,
        medium: school.medium,
        board_id: school.board_id,
        android_app_url: school.android_app_url,
        google_business_url: school.google_business_url,
        street_address: school.street_address,
        school_key: school.school_key,
        description: school.description,
        is_generated_domain: school.is_generated_domain,

        //setting
        academic_year_id: school.academic_year_id,
        admission_seed: school.admission_seed,
        admission_prefix: school.admission_prefix,
        admission_postfix: school.admission_postfix,
        ticket_url: school.ticket_url,
        ticket_userid: school.ticket_userid,
        ticket_password: school.ticket_password,
        create_homework: school.create_homework,
        is_email_notify: school.is_email_notify,
        is_sms_notify: school.is_sms_notify ? 'On' : 'Off',
        is_teacher_reply: school.is_teacher_reply,
        is_teacher_compose: school.is_teacher_compose,
        is_parent_reply: school.is_parent_reply,
        is_parent_compose: school.is_parent_compose,
        is_enable_email: school.is_enable_email ? 'On' : 'Off',
        is_attendance_backdate: school.is_attendance_backdate,
        is_parent_newsletter: school.is_parent_newsletter,
        is_teacher_newsletter: school.is_teacher_newsletter,
        is_student_roll_softable: school.is_student_roll_softable,
        is_class_wise_report: school.is_class_wise_report,
        is_teacher_self_attendance: school.is_teacher_self_attendance,
        is_password_visible: school.is_password_visible,
        is_biometric_integration: school.is_biometric_integration,
        is_student_biometric_attendance: school.is_student_biometric_attendance,
        is_view_parent_contact: school.is_view_parent_contact,
        is_view_tc_copy: school.is_view_tc_copy,
        is_pay_online_fee_voucher: school.is_pay_online_fee_voucher,
        is_uploaded_photo_app: school.is_uploaded_photo_app,
        is_transport_boarding_student: school.is_transport_boarding_student,
        is_event_module_teacher_login: school.is_event_module_teacher_login,
        is_allow_upload_document: school.is_allow_upload_document,
        is_weekly_status_send_to_parent: school.is_weekly_status_send_to_parent,
        image: "",
        image2: imageData?.path,
        duration: school.duration,
        training_url: school.training_url,
        admin_number: school.admin_number,
        client_name: school.client_name,

        school_board_id: school.school_board_id,
        school_country_id: school.school_country_id,
        school_setting_id: school.school_setting_id,
        school_state_id: school.school_state_id,
        school_timezone_id: school.school_timezone_id,
    });


    const updateSchoolData = (e) => {
        e.preventDefault();
        post(route("school.update_post"), {
            preserveScroll: true,
            onSuccess: () => reset()
        });
    };
    ...
    return (
        <div className="educare-create-school-area p-[30px] maxXs:p-[15px] rounded-[10px] bg-white/70">
            <form onSubmit={updateSchoolData}>
                                            ...
                                            <div className="col-span-12">
                                                <div className="educare-input-field-styles">
                                                    ...
                                                    <SelectInput
                                                        ...
                                                        data={boards}
                                                        value={data.board_id}
                                                        onChange={(e) => { handelBoard(e.target.value) }}
                                                        type="text"
                                                        className="block"
                                                    />
                                    ...
                                    <div className="educare-create-school-settings flex flex-col gap-y-6 border-t border-grayLight/20 pt-6">
                                                ...
                                                <div className="educare-create-school-settings-list-check">
                                                    <div className="educare-input-field-styles">
                                                        <TextInput
                                                            ...
                                                            type="text"
                                                            className="block"
                                                            disabled={data.is_generated_domain ? true : false}
                                                        />
                                        ...
                                        <div className="educare-button-field-styles mt-2.5">
                                            <DangerButton
                                                ...
                                                className="educare-danger-btn-lg-stroke mr-5"
                                            >
                                                Cancel
                                            </DangerButton>
                                            <PrimaryButton
