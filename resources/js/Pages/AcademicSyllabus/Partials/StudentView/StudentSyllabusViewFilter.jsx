...
const StudentSyllabusViewFilter = ({ students = [], academicSyllabuses, studentId }) => {
    ...
    const academicSyllabusFilterData = (e) => {
        e.preventDefault();
    };
    ...
    const studentChange = (e) => {
        ...
        router.post(route("student_syllabus.list"), updatedData, {
            preserveScroll: true,
        });
    };
        ...
        <div className='educare-admission-filtar-bar-area z-[4] relative'>
            <div className="py-3 pt-0 educare-header-filtar-bar-wrap">
                <div className="educare-header-filtar-bar-main">
                    <form onSubmit={academicSyllabusFilterData}>
                        <div className=" educare-header-filtar-bar-inner-main minMaxXl:flex-wrap minMaxXl:justify-end minMax2Xl:flex-wrap minMax2Xl:justify-end  minMax3Xl:flex-wrap minMax3Xl:justify-end">
                            <div className="educare-header-filtar-bar-count mr-auto">
                                <span>Total: {academicSyllabuses?.length}</span>
                            </div>
...
export default StudentSyllabusViewFilter;
