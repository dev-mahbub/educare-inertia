                                                        ...
                                                        <div className="min-width-full">
                                                            <div className="educare-radio-field-styles flex gap-3">
                                                                <RadioInput
                                                                    ...
                                                                    checked={item?.pivot?.exam_status === "Published"}
                                                                    onChange={() => handleExamStatusChange(item?.id, 'Published')}
                                                                    customClass={`input-hidden ${item?.pivot?.exam_status === "Published" ? "educare-success-btn-md-fill" : "educare-success-btn-md-stroke"}`}
                                                                />
                                                                <RadioInput
                                                                    name={`exam_status_${index}`}
                                                                    value="Unpublished"
                                                                    checked={item?.pivot?.exam_status === "Unpublished"}
                                                                    onChange={() => handleExamStatusChange(item?.id, 'Unpublished')}
                                                                    customClass={`input-hidden ${item?.pivot?.exam_status === "Unpublished" ? "educare-danger-btn-md-fill" : "educare-danger-btn-md-stroke"}`}
                                                                />
                                                            </div>
                                                        </div>
                                                    </div> */}
