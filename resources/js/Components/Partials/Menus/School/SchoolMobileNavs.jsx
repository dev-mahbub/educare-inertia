...
const menuData = [
    { label: "Notification", navsUrl: "#" },
    { label: "Add School", navsUrl: route('school.create') },
    { label: "Schools List", navsUrl: route('school.list') },
    { label: "Invoice",  navsUrl: "#" },
    { label: "Subscriptions",  navsUrl: "#" },
    { label: "Estimates",  navsUrl: "#" },
    { label: "Payments",  navsUrl: "#" },
    { label: "Service Orders",  navsUrl: "#" },
    { label: "SMS Orders",  navsUrl: "#" },
    { label: "Reports",  navsUrl: "#" },
];

const SchoolMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default SchoolMobileNavs;
