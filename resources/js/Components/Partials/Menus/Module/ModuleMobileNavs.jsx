...
const menuData = [
    ...
    { label: "Assign Modules to School", navsUrl: '/modules' },
    { label: "Assign Modules to User", navsUrl: '/permissions' },
];

const ModuleMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default ModuleMobileNavs;
