...
const menuData = [
    ...
    { label: "Visitor Enquiry", navsUrl: route('visitor_enquiry.create') },
    { label: "Visitor List", navsUrl: route('visitor_enquiry.list') },
    {
        label: "Master",
        subItems: [
            { label: "Enquiry Type", navsUrl: route('visitor_enquiry.type') },
            { label: "Enquiry Setting", navsUrl: route('visitor_enquiry.setting') },
        ],
    },
    {
        label: "Gate Pass",
        subItems: [
            { label: "Student Safety Gate Pass", navsUrl: route('visitor_enquiry.gate_pass') },
            { label: "Gate Pass Class Wise Summary", navsUrl: route('visitor_enquiry.gate_pass_class_wise') },
        ],
    },

];

const EnquiryMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default EnquiryMobileNavs;
