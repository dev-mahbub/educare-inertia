...
import WebMessageMobileNavs from './WebMessageMobileNavs'

const WebMessageHeaderMenus = () => {
    ...
    return (
        <>
                    ...
                    <div className="educare-mis-report-menu-right">
                        <div className="educare-mis-report-category">
                            <div className="educare-mis-report-category-wrap hidden sm:inline-block">
                                <ul>
                                    <li>
                                        <Link href={route('webmessage.compose')}>Compose</Link>
                                    </li>
                                    <li>
                                        <Link href={route('webmessage.inbox')}>Inbox</Link>
                                    </li>
                                    <li>
                                        <Link href={route('webmessage.sent')}>Sent</Link>
                                    </li>
                                </ul>
                            </div>
            ...
            <WebMessageMobileNavs isMobileNavsShow={isMobileNavsShow} onRemoveMobileNavs={() => setIsMobileNavsShow(false)} />
            {/* Mobile Navs Component End */}
        </>
    );
};

export default WebMessageHeaderMenus;
