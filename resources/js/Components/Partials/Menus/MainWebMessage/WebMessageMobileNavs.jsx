...
const menuData = [
    ...
    { label: "Compose", navsUrl: route('webmessage.compose') },
    { label: "Inbox", navsUrl: route('webmessage.inbox') },
    { label: "Sent", navsUrl: route('webmessage.sent') },
];

const WebMessageMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default WebMessageMobileNavs;
