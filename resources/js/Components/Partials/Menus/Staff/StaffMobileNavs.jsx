...
const menuData = [
    ...
    { label: "Active Staffs", navsUrl: '/staffs' },
    { label: "Inactive Staffs", navsUrl: '/staff/inactive' },
    { label: "Import", navsUrl: '/import/staff' },
    { label: "Download", navsUrl: '#' },
    { label: "Create Staff", navsUrl: '/staff/create' },

];

const StaffMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default StaffMobileNavs;
