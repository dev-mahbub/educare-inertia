...
import EventMobileNavs from './EventMobileNavs'

const EventHeaderMenus = ({menuTitle}) => {
    ...
    return (
        <>
                ...
                <div className="educare-mis-report-menu">
                    ...
                    <div className="educare-mis-report-menu-right">
                        <div className="educare-mis-report-category">
                            <div className="educare-mis-report-category-wrap educare-student-mis-report-category-wrap hidden sm:inline-block">
                                <ul>
                                    <li>
                                        <Dropdown>
                                            <Dropdown.Trigger>
            ...
            <EventMobileNavs isMobileNavsShow={isMobileNavsShow} onRemoveMobileNavs={() => setIsMobileNavsShow(false)} />
            {/* Mobile Navs Component End */}
        </>
    );
};

export default EventHeaderMenus;
