...
const menuData = [
    ...
    { label: "Add a Ticket", navsUrl: route('support_ticket.create') },
    { label: "Parents Requests", navsUrl: route('support_ticket.list') },
    { label: "Student and Parents Support Page", navsUrl: route('support_ticket.student_parents_support') },
    { label: "Staff Support Page", navsUrl: route('support_ticket.staff_support') },
];

const HelpDeskMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default HelpDeskMobileNavs;
