...
const menuData = [
    ...
    { label: "Add Alumni", navsUrl: route('alumni.create') },

    {
        label: "Reports",
        subItems: [
            { label: "Alumni List", navsUrl: route('alumni.list') },
            { label: "Payment List", navsUrl: route('alumni.payment') },
        ],
    },
];

const AlumniMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default AlumniMobileNavs;
