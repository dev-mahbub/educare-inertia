...
const menuData = [
    ...
    { label: "Team Manage", navsUrl: route('team.team_manage') },
    { label: "Member Manage", navsUrl: route('team.member_manage') },
    { label: "Team Report", navsUrl: route('team.team_report') },
];

const TeamMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
