...
const menuData = [
    ...
    { label: "New Survey", navsUrl: route('survey.create') },
    { label: "Survey Design", navsUrl: route('survey.design') },
    { label: "Reports", navsUrl: route('survey.audiencewise_report') },
];

const SurveyMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default SurveyMobileNavs;
