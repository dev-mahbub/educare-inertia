...
import SurveyMobileNavs from './SurveyMobileNavs'

const SurveyHeaderMenus = ({ title }) => {
    ...
    return (
        <>
            ...
            <SurveyMobileNavs isMobileNavsShow={isMobileNavsShow} onRemoveMobileNavs={() => setIsMobileNavsShow(false)} />
            {/* Mobile Navs Component End */}
        </>
    );
};

export default SurveyHeaderMenus;
