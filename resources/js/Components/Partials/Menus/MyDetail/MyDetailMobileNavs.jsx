...
const menuData = [
    ...
    { label: "My Detail Salary", navsUrl: route('profile.mydetail.salary') },
    { label: "My Detail Attendance", navsUrl: route('profile.mydetail_attendance') },
    { label: "My Detail Leave", navsUrl: route('profile.mydetail_leave') },

];

const MyDetailMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default MyDetailMobileNavs;
