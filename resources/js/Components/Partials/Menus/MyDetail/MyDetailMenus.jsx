...
import MyDetailMobileNavs from './MyDetailMobileNavs'

const MyDetailMenus = ({ title }) => {
    ...
    return (
        <>
            ...
            <MyDetailMobileNavs isMobileNavsShow={isMobileNavsShow} onRemoveMobileNavs={() => setIsMobileNavsShow(false)} />
            {/* Mobile Navs Component End */}
        </>
    );
};

export default MyDetailMenus;
