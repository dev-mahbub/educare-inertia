...
const menuData = [
    ...
    { label: "Create Template", navsUrl: route('certificate.cert_template') },
...
const CertificateMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default CertificateMobileNavs;
