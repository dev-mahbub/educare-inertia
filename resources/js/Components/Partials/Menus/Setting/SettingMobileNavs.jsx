...
const menuData = [
    ...
    { label: "Assign Modules to School", navsUrl: route('/modules') },
    { label: "Assign Modules to User", navsUrl: route('/permissions') },

];

const SettingMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default SettingMobileNavs;
