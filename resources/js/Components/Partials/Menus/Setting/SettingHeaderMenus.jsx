...
import SettingMobileNavs from './SettingMobileNavs'

const SettingHeaderMenus = () => {
    ...
    return (
        <>
            ...
            <SettingMobileNavs isMobileNavsShow={isMobileNavsShow} onRemoveMobileNavs={() => setIsMobileNavsShow(false)} />
            {/* Mobile Navs Component End */}
        </>
    );
};

export default SettingHeaderMenus;
