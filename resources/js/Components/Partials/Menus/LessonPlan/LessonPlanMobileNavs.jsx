...
const menuData = [
    ...
    { label: "Lesson Plans", navsUrl: route('lesson_plan.list') },
    { label: "Share By Others", navsUrl: route('lesson_plan.shared_by_other') },
    // { label: "reports", navsUrl: "#" },
    {
        label: "Reports",
        subItems: [
            { label: "Teacher Wise", navsUrl: route('lesson_plan.teacher_wise_report') },
            { label: "Class Wise", navsUrl: route('lesson_plan.class_wise_report') },
        ],
    },
    { label: "Create Lesson Plans", navsUrl: route('lesson_plan.create') },

];

const LessonPlanMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default LessonPlanMobileNavs;
