...
const menuData = [
    ...
    { label: "Public Job Listing Link", navsUrl: route('#') },

    {
        label: "Jobs",
        subItems: [
            { label: "Job Postings", navsUrl: route('#') },
            { label: "Post a Job", navsUrl: route('#') },
        ],
    },
    {
        label: "Applicants",
        subItems: [
            { label: "All Candidates", navsUrl: route('#') },
            { label: "Add a candidate", navsUrl: route('#') },
        ],
    },
];

const JobMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
