...
const menuData = [
    ...
    { label: "Notes", navsUrl: '#' },
    { label: "Subject Marks", navsUrl: '#' },
    { label: "Subject Wise Percentage", navsUrl: '#' },
    { label: "Student Fees", navsUrl: '#' },
    { label: "Attendance Report", navsUrl: '#' },
];

const StudentDetailMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default StudentDetailMobileNavs;
