...
const menuData = [
    ...
    { label: "Inactive Teachers", navsUrl: '/teacher/inactive' },
    { label: "Import", navsUrl: '/import/teacher' },
    { label: "Download", navsUrl: '#' },
    { label: "Create Teacher", navsUrl: '/teacher/create' },
];

const TeacherMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default TeacherMobileNavs;
