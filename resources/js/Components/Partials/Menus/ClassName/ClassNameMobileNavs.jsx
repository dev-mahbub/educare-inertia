...
const menuData = [
    ...
    { label: "Assign Class Teachers", navsUrl: route('classroom.assign_teacher') },
    { label: "Assign Display Order", navsUrl: route('classroom.assign_order') },
    { label: "Add/Edit Class with Sections", navsUrl: route('class_name.list') },

];

const ClassNameMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default ClassNameMobileNavs;
