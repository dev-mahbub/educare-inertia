...
const menuData = [
    { label: "Fee Due Report", navsUrl: route('fee_report.teacher.student_due_report') },
    { label: "Daily Collection", navsUrl: route('fee_report.teacher.student_daily_collection_report') },
    { label: "Complete Paid Report", navsUrl: route('fee_report.teacher.student_complete_paid_report') },

];

const TeacherFeeMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default TeacherFeeMobileNavs;
