...
import FeeMobileNavs from './TeacherFeeMobileNavs';


const TeacherFeeHeaderMenus = ({ title }) => {
                    ...
                    <div className="educare-mis-report-menu-right">
                        <div className="educare-mis-report-category">
                            <div className="educare-mis-report-category-wrap hidden sm:inline-block">
                                <ul>
                                    <li>
                                        <Link href={route('fee_report.teacher.student_due_report')}>Fee Due Report</Link>
                                    </li>
                                    <li>
                                        <Link href={route('fee_report.teacher.student_daily_collection_report')}>Daily Collection</Link>
                                    </li>
                                    <li>
                                        <Link href={route('fee_report.teacher.student_complete_paid_report')}>Complete Paid Report</Link>
                                    </li>
                                </ul>
                            </div>
...
export default TeacherFeeHeaderMenus;
