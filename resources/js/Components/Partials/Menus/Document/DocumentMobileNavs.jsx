...
const menuData = [
    ...
    { label: "Dashboard", navsUrl: route('document.dashboard') },
    {
        label: "Master",
        subItems: [
            { label: "Add Category", navsUrl: '#' },
        ],
    },
    { label: "Upload Documents", navsUrl: route('document.dashboard') },
    { label: "School Documents", navsUrl: route('document.dashboard') },
    { label: "Driver Documents", navsUrl: route('document.dashboard') },
    {
        label: "Teacher Documents",
        subItems: [
            { label: "Approved", navsUrl: '#' },
        ],
    },
    {
        label: "Student Documents",
        subItems: [
            { label: "Student Class Wise Report", navsUrl: route('classroom_attendance.take_attendance') },
            { label: "Student Wise Report", navsUrl: route('classroom_attendance.take_attendance') },
        ],
    },
...
const DocumentMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default DocumentMobileNavs;
