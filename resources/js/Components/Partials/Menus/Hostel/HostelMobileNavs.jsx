...
const menuData = [
    ...
    { label: "Setup Hostel", navsUrl: route('hostel.setup_hostel') },
    { label: "Allocation", navsUrl: route('hostel.allocation') },
    { label: "Deallocation", navsUrl: route('hostel.deallocation') },

    {
        label: "Report",
        subItems: [
            { label: "Class Wise Report", navsUrl: route('hostel_report.class_summary') },
            { label: "Allocation Report", navsUrl: route('hostel_report.allocation') },
            { label: "Deallocation Report", navsUrl: route('hostel_report.deallocation') },
            { label: "Staff Allocation Report", navsUrl: route('hostel_report.staff_allocation') },
        ],
    },
    { label: "Room Type", navsUrl: route('hostel_room.list') },
    {
        label: "Gate Pass",
        subItems: [
            { label: "Student Safety Gate Pass", navsUrl: route('hostel.gate_pass') },
            { label: "Class wise Gate Pass", navsUrl: route('hostel.gate_pass_class_wise') },
        ],
    },
    {
        label: "Hostel Fee",
        subItems: [
            { label: "Hostel Fee Group", navsUrl: route('hostel.fee_group') },
            { label: "Hostel Voucher", navsUrl: route('hostel.voucher') },
            { label: "Assign Hostel Fee To Student", navsUrl: route('hostel.assign_fee') },
        ],
    },
];

const HostelMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default HostelMobileNavs;
