...
const menuData = [
    ...
    { label: "Add/Edit Class", navsUrl: '#' },
    { label: "Assign Class Teachers", navsUrl: '#' },
    { label: "Assign Display Order", navsUrl: '#' },
];

const TopicMobileNavs = ({ isMobileNavsShow, onRemoveMobileNavs }) => {
...
export default TopicMobileNavs;
