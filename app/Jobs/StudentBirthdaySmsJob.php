...
class StudentBirthdaySmsJob implements ShouldQueue
{
     ...
     */
    public function __construct(private $parrentsSmsPhones, private $message)
    {
        //
    }
    ...
    {
        foreach ($this->parrentsSmsPhones as $parentSmsPhone) {
            // send sms to parent
            $number = $parentSmsPhone ?? '';
