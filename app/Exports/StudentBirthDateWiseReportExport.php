...
class StudentBirthDateWiseReportExport implements FromCollection, WithEvents
{
    protected $reports = [];
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // Set heading for merged cells
                $event->sheet->setCellValue('A2', " Report - Date Of Birth And Date Of Admission Wise Report");
