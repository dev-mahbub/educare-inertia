...
class AttendanceNotTakenReportExport implements FromCollection, WithEvents
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // Set heading for merged cells
                $event->sheet->setCellValue('A2', "Daily Attendance Report Date: $this->attendanceReportDate");
                ...
                // Set heading for merged cells
                $event->sheet->setCellValue('A3', $this->academicYear);
