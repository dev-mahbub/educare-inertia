...
class StudentCategoryWiseSummaryReportExport implements FromCollection, WithEvents
{
    protected $reports = [];
    ...
    public function __construct(array $reports, string $schoolTitle, array $categories)
    {
        ...
        if (!empty($this->reports)) {
            foreach ($this->reports as $report) {
                foreach ($this->headings as $heading) {
                    if (in_array($heading, $this->categories)) {
    ...
    {
        array_push($this->headings, ...$this->categories);
    }
}
