...
class DateWiseClassAttendanceReportExport implements FromCollection, WithEvents
{
        ...
        if (!empty($this->attendanceReport)) {
            foreach ($this->attendanceReport as $report) {
                foreach ($this->headings as $heading) {
                    if (in_array($heading, ['present', 'absent', 'percentage'])) {
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // Set heading for merged cells
                $event->sheet->setCellValue('A2', "Class wise student attendance report ($this->academicYear)");
