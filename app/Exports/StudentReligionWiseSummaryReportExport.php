...
class StudentReligionWiseSummaryReportExport implements FromCollection, WithEvents
{
    protected $reports = [];
    ...
    public function __construct(array $reports, string $schoolTitle, array $religions)
    {
        ...
        if (!empty($this->reports)) {
            foreach ($this->reports as $report) {
                foreach ($this->headings as $heading) {
                    if (in_array($heading, $this->religions)) {
    ...
    {
        array_push($this->headings, ...$this->religions);
    }
}
