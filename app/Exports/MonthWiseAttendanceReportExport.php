...
class MonthWiseAttendanceReportExport implements FromCollection, WithEvents
{
    ...
    public function __construct(array $attendanceReport, string $schoolTitle, string $academicYear, string $classroomTitle)
    {
    ...
    public function collection()
    {
        ...
        if (!empty($this->attendanceReport)) {
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // Set heading for merged cells
                $event->sheet->setCellValue('A2', "Month wise student attendacne report ($this->academicYear)");
                ...
                // Set heading for merged cells
                $event->sheet->setCellValue('A3', "Class - $this->classroomTitle");
