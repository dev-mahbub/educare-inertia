...
return new class extends Migration
{
    ...
    {
        Schema::create('working_bonus_day_students', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('working_bonus_day_classroom_id')->nullable();
    ...
    {
        Schema::dropIfExists('working_bonus_day_students');
    }
};
